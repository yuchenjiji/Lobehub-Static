import{j as t}from"../vendor/vendor-motion--v3N1cMI.js";import{aG as g,b6 as S,f as w,I as f}from"./index-DgmZNIaB.js";import{M as j}from"./Markdown-TJUkwStj.js";import{r as d}from"../vendor/vendor-emotion-D8kPrniB.js";import{aZ as v,a_ as k,Q as N,a$ as C,Z as L}from"../vendor/vendor-icons-DA3bMca7.js";const x=w(({css:e,cssVar:a})=>({codeWrapper:e`
    position: relative;
    overflow-x: auto;
  ...
  `,label:e`
    ...
    white-space: nowrap;
  `})),y=d.memo(({node:e,depth:a,selectedFile:l,onSelectFile:p,expandedFolders:c,onToggleFolder:n})=>{const s=e.type==="directory",o=c.has(e.path),r=!s&&l===e.path,m=()=>{s?n(e.path):p(e.path)};return t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:`${u.item} ${r?u.itemSelected:""}`,style:{paddingInlineStart:8+a*16},title:e.path,onClick:m,children:[s&&t.jsx(f,{icon:o?k:N,size:14}),!s&&t.jsx("span",{style:{flexShrink:0,width:14}}),t.jsx(f,{icon:s?o?C:L:v,size:16}),t.jsx("span",{className:u.label,children:e.name})]}),s&&o&&e.children?.map(i=>t.jsx(y,{depth:a+1,expandedFolders:c,node:i,selectedFile:l,onSelectFile:p,onToggleFolder:n},i.path))]})});y.displayName="TreeNode";const q=d.memo(({resourceTree:e,selectedFile:a,onSelectFile:l})=>{const[p,c]=d.useState(new Set);d.useEffect(()=>{const r=new Set,m=i=>{for(const h of i)h.type==="directory"&&(r.add(h.path),h.children&&m(h.children))};m(e),c(r)},[e]);const n=d.useCallback(r=>{c(m=>{const i=new Set(m);return i.has(r)?i.delete(r):i.add(r),i})},[]),s=a==="SKILL.md",o=d.useMemo(()=>e.length>0,[e]);return t.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:2},children:[t.jsxs("div",{className:`${u.item} ${s?u.itemSelected:""}`,style:{paddingInlineStart:8},onClick:()=>l("SKILL.md"),children:[t.jsx("span",{style:{flexShrink:0,width:14}}),t.jsx(f,{icon:v,size:16}),t.jsx("span",{className:u.label,children:"SKILL.md"})]}),o&&e.map(r=>t.jsx(y,{depth:0,expandedFolders:p,node:r,selectedFile:a,onSelectFile:l,onToggleFolder:n},r.path))]})});q.displayName="FileTree";export{F as C,q as F};
