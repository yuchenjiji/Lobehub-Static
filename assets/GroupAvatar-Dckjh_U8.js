import{B as M}from"./Block-D_uMJtCN.js";import{A as x}from"./index-CsJPAo_O.js";import{G as S}from"./Grid-DuIJSUBX.js";import{z as b,h as k,l as q}from"./index-CMYT05q7.js";import{r as f}from"../vendor/vendor-emotion-D8kPrniB.js";import{j as p}from"../vendor/vendor-motion-ksfQGfvU.js";const z=(e,s=4)=>{const t=e/2,r=[];for(let o=0;o<=360;o+=2){const n=o*Math.PI/180,l=Math.cos(n),g=Math.sin(n),a=t*Math.sign(l)*Math.pow(Math.abs(l),2/s),u=t*Math.sign(g)*Math.pow(Math.abs(g),2/s);r.push(`${t+a},${t+u}`)}return`M${r[0]}L${r.slice(1).join("L")}Z`},d=(e={})=>{const{size:s=100,cornerValue:t=4}=e,r=`
