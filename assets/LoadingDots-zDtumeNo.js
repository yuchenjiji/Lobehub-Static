import{h as m,l as y}from"./index-DuTkvx3R.js";import{r as p}from"../vendor/vendor-emotion-D8kPrniB.js";import{j as t}from"../vendor/vendor-motion-D2gXNOxm.js";const i=m(({css:e,cssVar:n})=>{const a="var(--loading-dots-size, 8px)",s="var(--loading-dots-color, var(--ant-color-primary))";return{container:e`
      display: flex;
      flex-direction: row;
      gap: 6px;
      align-items: center;
