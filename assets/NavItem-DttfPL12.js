import{j as e}from"../vendor/vendor-motion-D2gXNOxm.js";import{F as s,m as i,C as S,I as z,y as B,l as D,h as I}from"./index-Dw0E06JZ.js";import{S as f}from"./index-DxOkZSvZ.js";import{r as d}from"../vendor/vendor-emotion-D8kPrniB.js";import{B as P}from"./Block-MHS1RMdI.js";import{C as R}from"./ContextMenuTrigger-DtVUWsX6.js";import{N as A}from"./index-GRI0r0_D.js";import"./providerConfig-CULHvVzb.js";const E=d.memo(({padding:t=6,height:n=36,style:l,avatarSize:o=28,...a})=>e.jsxs(s,{horizontal:!0,align:"center",flex:1,gap:8,height:n,padding:t,style:l,...a,children:[e.jsx(f.Button,{size:"small",style:{borderRadius:i.borderRadius,height:o,maxHeight:o,maxWidth:o,minWidth:o}}),e.jsx(s,{flex:1,height:16,children:e.jsx(f.Button,{active:!0,block:!0,size:"small",style:{borderRadius:i.borderRadius,height:16,margin:0,maxHeight:16,opacity:.5,padding:0}})})]})),G=d.memo(({rows:t=3,...n})=>e.jsx(s,{gap:2,...n,children:Array.from({length:t}).map((l,o)=>e.jsx(E,{},o))})),L=t=>t.metaKey||t.ctrlKey,c="nav-item-actions",O=I(({css:t})=>({container:t`
    user-select: none;
    overflow: hidden;
    min-width: 32px;
