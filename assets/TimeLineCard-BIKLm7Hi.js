import{j as t}from"../vendor/vendor-motion-D2gXNOxm.js";import{j as G,F as s,I as K,dY as b,h as S,A as W,Q as A,aw as re,fb as ne,fc as ie,bN as ae,fd as B,fe as F,T as D,m as M,y as g,a9 as w,C as se,l as _,bq as le}from"./index-DTW0VVHo.js";import{S as ce}from"./SearchBar-C3pp9bg7.js";import{S as de}from"./Select-D4LkYePl.js";import{r as l}from"../vendor/vendor-emotion-D8kPrniB.js";import{k as me,d8 as pe,d9 as ue,c0 as ge,bM as he}from"../vendor/vendor-icons-UxbXHH06.js";import{EditorModal as xe}from"./index-Dv-djuUV.js";import{u as k}from"./store-4TVpQY9e.js";import{S as d}from"./index-iEwlIla2.js";import{N as fe}from"./index-CL569NYv.js";import{R as ye,T as je}from"./ToggleRightPanelButton-DxGt8G6k.js";import{M as we}from"./Markdown-Bs8KWKCE.js";import{G as Q}from"./Grid-DAom0ydE.js";import{J as ve,Y as Ce}from"./index-Blxz1U9m.js";import{u as U}from"./useScrollParent-CeUYHmCl.js";import{B as I}from"./Block-BgH28pIQ.js";const Oe=l.memo(({searchValue:o,onSearch:e,sortValue:r,onSortChange:n,sortOptions:a})=>{const{t:c}=G("memory");return t.jsxs(s,{horizontal:!0,align:"center",gap:12,children:[t.jsx(ce,{allowClear:!0,defaultValue:o,placeholder:c("filter.search"),prefix:t.jsx(me,{size:16}),style:{flex:1},onSearch:i=>e(i),onInputChange:i=>{i||e(i)}}),a&&a.length>0&&n&&t.jsx(de,{options:a,prefix:t.jsx(K,{icon:pe,style:{marginRight:4}}),style:{minWidth:150},value:r,onChange:i=>n(i)})]})}),Ve=l.memo(()=>{const o=k(i=>i.editingMemoryId),e=k(i=>i.editingMemoryContent),r=k(i=>i.editingMemoryLayer),n=k(i=>i.clearEditingMemory),a=k(i=>i.updateMemory),c={activity:b.Activity,context:b.Context,experience:b.Experience,identity:b.Identity,preference:b.Preference};return t.jsx(xe,{open:!!o,value:e,onCancel:n,onConfirm:async i=>{!o||!r||await a(o,i,c[r])}})}),be=S(({css:o,cssVar:e})=>({card:o`
    display: flex;
