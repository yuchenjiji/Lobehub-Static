import{j as e}from"../vendor/vendor-motion-D2gXNOxm.js";import{j as $,az as _,e as Se,F as r,m as o,I as ne,B as E,h as O,aF as Y,y as J,C as ze,T as ke,L as Te,aJ as F,ap as we}from"./index-Co46OOry.js";import{r as n}from"../vendor/vendor-emotion-D8kPrniB.js";import{u as I,a as Z}from"./store-1AEl3kry.js";import"../vendor/vendor-es-toolkit-BI0f0n_g.js";import{e as De}from"./format-CS5m722Q.js";import"./providerConfig-CULHvVzb.js";import{I as ae}from"./Input-D5pSkrMs.js";import{T as Ie}from"./TextArea-audSroCx.js";import{M as oe}from"./Modal-C9AneL8v.js";import{S as Fe}from"./Select-DCp4b5HU.js";import{F as w}from"./index-B0DrcYTv.js";import{f as Be,a as Re}from"./utils-DdCRt2d3.js";import{bc as le,U as Ne,z as V,cv as Ae,cx as Me,bG as ie,c as Pe,a9 as Ee,cy as We,bf as X,aZ as H,cz as Le,s as $e,cl as Oe,P as _e,Q as qe,bA as Qe,bD as Ue,bE as He,ak as Ge,bF as Je,a8 as Ke,bH as Ye,bI as Ze,bJ as Ve,bK as Xe}from"../vendor/vendor-icons-UxbXHH06.js";import{D as ce}from"./index-ClIOgtNB.js";import{B as de}from"./index-t8-2X6wl.js";import{g as et,d as U,T as tt,D as at,a as st,b as rt,c as ue,E as nt,R as ot}from"./RunCard-vafV-dcg.js";import{I as q}from"./index-DGv_G2c1.js";import{N as lt}from"./index-Cll9R1On.js";import{C as G}from"./index-e42_K_O6.js";import{E as it}from"./Empty-CJPCUd5w.js";import{R as ct}from"./index-DFbCXlXV.js";import{r as pe}from"./selectors-D8FoU16Z.js";import"../i18n/i18n-zh-CN-X4QEO1fZ.js";import"../i18n/i18n-en-US-CeDxYD3m.js";import"./currency-iJxIWo9y.js";import"./style-D3LR9BoD.js";import"./Drawer-9_ArTfmI.js";import"./useForm-DEE6a4GA.js";import"./row-DEzHf7l1.js";import"./index-Tnw7UMgW.js";import"./LeftOutlined-e6mUbGnU.js";import"./Dropdown-E59tEqdx.js";import"./index-CT0l17fa.js";import"./EllipsisOutlined-CGJYRTbr.js";import"./index-CVjNP41S.js";import"./Addon-vra2xggg.js";import"./upload-CQKC7KiO.js";import"./index-BkrHTVUC.js";import"./object-Cz6o-AEA.js";import"./_url-Cnt5F35V.js";import"./v4-BKrj-4V8.js";import"./index-CPuxBiS3.js";import"./useBubbleLock-6kkEthu_.js";import"./Table-jzc7tZWz.js";import"./index-w94xxhG1.js";import"./scrollTo-CRnU52X3.js";import"./Pagination-CQqxASzo.js";import"./index-CYIcqqsJ.js";import"./index-CSVu88a3.js";import"./Input-D66QE2T1.js";import"./index-STNGqpwv.js";import"./index-DnqkIG26.js";import"./DeleteOutlined-DFutYCzo.js";import"./EyeOutlined-CAo4Z7BD.js";import"./progress-BuXaT8CT.js";import"./AccordionItem-B-0JrzDJ.js";import"./Block-DTrzmjZ1.js";import"./index-CMPDGxbE.js";import"./index-cXSBe9G0.js";import"./index-BP-9hJFu.js";import"./index-UfilCxLL.js";import"./PlusOutlined-CHMXKujE.js";import"./StatusBadge-Mqkd1zKU.js";import"./TextArea-WM7ohBpG.js";import"./index-CDeX135d.js";const dt=a=>a.trim().toLowerCase().replaceAll(/\s+/g,"-").replaceAll(/[^\da-z-]/g,""),ut=n.memo(({open:a,onCancel:t,benchmark:m,onSuccess:D})=>{const{t:s}=$("eval"),{message:g}=_.useApp(),[l]=w.useForm(),[h,f]=n.useState(!1),[T,b]=n.useState(!1),v=I(S=>S.updateBenchmark),C=w.useWatch("name",l);return n.useEffect(()=>{a&&m&&(l.setFieldsValue({name:m.name,identifier:m.identifier,description:m.description||"",tags:m.tags||[]}),b(!1))},[a,m,l]),n.useEffect(()=>{!T&&C&&l.setFieldValue("identifier",dt(C))},[C,T,l]),e.jsx(oe,{allowFullscreen:!0,destroyOnHidden:!0,okButtonProps:{loading:h},okText:s("benchmark.edit.confirm"),open:a,title:s("benchmark.edit.title"),width:480,onCancel:S=>{l.resetFields(),b(!1),t?.(S)},onOk:async S=>{try{const d=await l.validateFields();f(!0),await v({id:m.id,identifier:d.identifier.trim(),name:d.name.trim(),description:d.description?.trim()||void 0,tags:d.tags?.length>0?d.tags:void 0}),g.success(s("benchmark.edit.success")),l.resetFields(),b(!1),t?.(S),D?.()}catch(d){if(d?.errorFields)return;g.error(s("benchmark.edit.error"))}finally{f(!1)}},children:e.jsxs(w,{form:l,layout:"vertical",style:{paddingBlock:16},children:[e.jsx(w.Item,{label:s("benchmark.create.name.label"),name:"name",rules:[{message:s("benchmark.create.nameRequired"),required:!0}],children:e.jsx(ae,{autoFocus:!0,placeholder:s("benchmark.create.name.placeholder")})}),e.jsx(w.Item,{label:s("benchmark.create.identifier.label"),name:"identifier",rules:[{message:s("benchmark.create.identifierRequired"),required:!0}],children:e.jsx(ae,{placeholder:s("benchmark.create.identifier.placeholder"),onChange:()=>b(!0)})}),e.jsx(w.Item,{label:s("benchmark.create.description.label"),name:"description",children:e.jsx(Ie,{placeholder:s("benchmark.create.description.placeholder"),rows:3})}),e.jsx(w.Item,{label:s("benchmark.create.tags.label"),name:"tags",style:{marginBottom:0},children:e.jsx(Fe,{mode:"tags",open:!1,placeholder:s("benchmark.create.tags.placeholder"),style:{width:"100%"},tokenSeparators:[",","，"," "]})})]})})}),se=[o.colorPrimary,o.colorSuccess,o.colorTextQuaternary],R=O(({css:a,cssVar:t})=>({bestPerformance:a`
    margin: 0;
