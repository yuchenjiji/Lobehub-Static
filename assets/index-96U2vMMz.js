import{j as t}from"../vendor/vendor-motion-D2gXNOxm.js";import{a4 as $,F as g,y as M,h as S,j as C,bo as T,aA as L,B as w}from"./index-BA-ev5QK.js";import{M as B}from"./Modal-BxpqEDcj.js";import{r as i}from"../vendor/vendor-emotion-D8kPrniB.js";import{S as _}from"./SearchBar-DkruzYjM.js";import{S as j}from"./index-BNxskjuv.js";import{q as N}from"./index-BcZQwVPm.js";import{A as k}from"./AgentSelectionEmpty-DtCGnseZ.js";import{A as R}from"./index-DTYhh_sv.js";import{C as F}from"./index-Bs2nk0ng.js";import{a as z}from"./index-D1M3mCgk.js";import{c as E}from"./react-CvLgVtuT.js";import{bd as q}from"../vendor/vendor-icons-UxbXHH06.js";import{D}from"./index-1edL7Eu-.js";const x=E((e,o)=>({clearSelection:()=>{e({selectedAgentIds:[]})},isSelected:n=>o().selectedAgentIds.includes(n),removeAgent:n=>{e(r=>({selectedAgentIds:r.selectedAgentIds.filter(l=>l!==n)}))},selectedAgentIds:[],setSelectedAgents:n=>{e({selectedAgentIds:n})},toggleAgent:n=>{e(r=>r.selectedAgentIds.includes(n)?{selectedAgentIds:r.selectedAgentIds.filter(s=>s!==n)}:{selectedAgentIds:[...r.selectedAgentIds,n]})}})),y=S(({css:e,cssVar:o})=>({item:e`
    cursor: pointer;
