import{j as t}from"../vendor/vendor-motion-D2gXNOxm.js";import{a4 as $,F as g,y as M,h as S,j as C,bo as T,aA as L,B as w}from"./index-CnQvfPte.js";import{M as B}from"./Modal-CgckoCfW.js";import{r as i}from"../vendor/vendor-emotion-D8kPrniB.js";import{S as _}from"./SearchBar--j1KOJYD.js";import{S as j}from"./index-C338Mx3U.js";import{q as N}from"./index-CIb74GHX.js";import{A as k}from"./AgentSelectionEmpty-BhurMwat.js";import{A as R}from"./index-BCY_Gb4b.js";import{C as F}from"./index-D497XGoG.js";import{a as z}from"./index-CMk2MmUP.js";import{c as E}from"./react-Cu0t7AOl.js";import{bd as q}from"../vendor/vendor-icons-UxbXHH06.js";import{D}from"./index-BbBpZ0jF.js";const x=E((e,o)=>({clearSelection:()=>{e({selectedAgentIds:[]})},isSelected:n=>o().selectedAgentIds.includes(n),removeAgent:n=>{e(r=>({selectedAgentIds:r.selectedAgentIds.filter(l=>l!==n)}))},selectedAgentIds:[],setSelectedAgents:n=>{e({selectedAgentIds:n})},toggleAgent:n=>{e(r=>r.selectedAgentIds.includes(n)?{selectedAgentIds:r.selectedAgentIds.filter(s=>s!==n)}:{selectedAgentIds:[...r.selectedAgentIds,n]})}})),y=S(({css:e,cssVar:o})=>({item:e`
    cursor: pointer;
