import{j as t}from"../vendor/vendor-motion-D2gXNOxm.js";import{a4 as $,F as g,y as M,h as S,j as C,bo as T,aA as L,B as w}from"./index-Co46OOry.js";import{M as B}from"./Modal-C9AneL8v.js";import{r as i}from"../vendor/vendor-emotion-D8kPrniB.js";import{S as _}from"./SearchBar-ye4Dh4YH.js";import{S as j}from"./index-D3_cOfIP.js";import{q as N}from"./index--4WAFHc4.js";import{A as k}from"./AgentSelectionEmpty-CA9IrU-G.js";import{A as R}from"./index-CMPDGxbE.js";import{C as F}from"./index-CiTpMrjg.js";import{a as z}from"./index-D_2VIjXW.js";import{c as E}from"./react-BMqYEsVS.js";import{bd as q}from"../vendor/vendor-icons-UxbXHH06.js";import{D}from"./index-STNGqpwv.js";const x=E((e,o)=>({clearSelection:()=>{e({selectedAgentIds:[]})},isSelected:n=>o().selectedAgentIds.includes(n),removeAgent:n=>{e(r=>({selectedAgentIds:r.selectedAgentIds.filter(l=>l!==n)}))},selectedAgentIds:[],setSelectedAgents:n=>{e({selectedAgentIds:n})},toggleAgent:n=>{e(r=>r.selectedAgentIds.includes(n)?{selectedAgentIds:r.selectedAgentIds.filter(s=>s!==n)}:{selectedAgentIds:[...r.selectedAgentIds,n]})}})),y=S(({css:e,cssVar:o})=>({item:e`
    cursor: pointer;
