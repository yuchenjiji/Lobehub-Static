import{j as l}from"../vendor/vendor-motion-D2gXNOxm.js";import{F as t,y as c,a_ as f,I as v,m as h,l as n,h as g,r as j}from"./index-DTW0VVHo.js";import{G as b}from"./Grid-DAom0ydE.js";import{r as p}from"../vendor/vendor-emotion-D8kPrniB.js";const m=p.memo(({className:r,style:o,value:a="--"})=>l.jsxs(t,{horizontal:!0,align:"center",className:r,gap:4,style:{overflow:"hidden",position:"relative",...o},children:[l.jsx(c,{ellipsis:!0,style:{color:"inherit",fontFamily:"inherit",fontSize:"inherit",margin:0,overflow:"hidden",width:"100%"},children:a||"--"}),l.jsx(f,{content:a||"--",size:"small"})]})),d=g(({css:r,cssVar:o})=>({bordered:r`
      overflow: hidden;
