import{j as e}from"../vendor/vendor-motion-D2gXNOxm.js";import{j as $,az as _,e as Se,F as r,m as o,I as ne,B as E,h as O,aF as Y,y as J,C as ze,T as ke,L as Te,aJ as F,ap as we}from"./index-BzLMjSCA.js";import{r as n}from"../vendor/vendor-emotion-D8kPrniB.js";import{u as I,a as Z}from"./store-8Z_Cc05x.js";import"../vendor/vendor-es-toolkit-BI0f0n_g.js";import{e as De}from"./format-Ns5ZgsQk.js";import"./providerConfig-CULHvVzb.js";import{I as ae}from"./Input-upQwBEwQ.js";import{T as Ie}from"./TextArea-BueNO2bk.js";import{M as oe}from"./Modal-Ds-3kfE8.js";import{S as Fe}from"./Select-DGv6HRx2.js";import{F as w}from"./index-nupYNZmn.js";import{f as Be,a as Re}from"./utils-DdCRt2d3.js";import{bc as le,U as Ne,z as V,cv as Ae,cx as Me,bG as ie,c as Pe,a9 as Ee,cy as We,bf as X,aZ as H,cz as Le,s as $e,cl as Oe,P as _e,Q as qe,bA as Qe,bD as Ue,bE as He,ak as Ge,bF as Je,a8 as Ke,bH as Ye,bI as Ze,bJ as Ve,bK as Xe}from"../vendor/vendor-icons-UxbXHH06.js";import{D as ce}from"./index-DmgOtmIf.js";import{B as de}from"./index-CJ9jXIiA.js";import{g as et,d as U,T as tt,D as at,a as st,b as rt,c as ue,E as nt,R as ot}from"./RunCard-D14zS3hq.js";import{I as q}from"./index-D4A48Xe5.js";import{N as lt}from"./index-Cd8dy2qj.js";import{C as G}from"./index-4LbBH5xH.js";import{E as it}from"./Empty-XQ9oDkc5.js";import{R as ct}from"./index-DkPNSgUm.js";import{r as pe}from"./selectors-D8FoU16Z.js";import"../i18n/i18n-zh-CN-X4QEO1fZ.js";import"../i18n/i18n-en-US-CeDxYD3m.js";import"./currency-iJxIWo9y.js";import"./style-BxTkysqP.js";import"./Drawer-Hm2Pb34R.js";import"./useForm-VLrgfUEK.js";import"./row-BsQCwDmk.js";import"./index-CuTnxV3I.js";import"./LeftOutlined-UeqPNbIG.js";import"./Dropdown-D9jCtlUN.js";import"./index-CGcGELKS.js";import"./EllipsisOutlined-DaWNeruF.js";import"./index-B1cenqWv.js";import"./Addon-Dcnlt-VM.js";import"./upload-Dczyb-QY.js";import"./index-0VWuRELK.js";import"./object-Cz6o-AEA.js";import"./_url-xP2ngzoi.js";import"./v4-BKrj-4V8.js";import"./index-Cr1Zvt1Z.js";import"./useBubbleLock-6kkEthu_.js";import"./Table-CqSMO04a.js";import"./index-6tR_yV2b.js";import"./scrollTo-XhO8_D_I.js";import"./Pagination-DrcG9rqT.js";import"./index-C_jL-jeT.js";import"./index-B2titnPd.js";import"./Input-GUFL8d4e.js";import"./index-C01IaG9-.js";import"./index-DtyaMwUE.js";import"./DeleteOutlined-DFutYCzo.js";import"./EyeOutlined-DaqTlU1J.js";import"./progress-CUAx977N.js";import"./AccordionItem-BxBIilwK.js";import"./Block-DisZY_e8.js";import"./index-C2Bs0zJB.js";import"./index-C-vrAyHP.js";import"./index-DfQYUH17.js";import"./index-B4Vu4vBO.js";import"./PlusOutlined-1mZvwt0F.js";import"./StatusBadge-CiZc-4HN.js";import"./TextArea-DKzrab1C.js";import"./index-DtneZUvo.js";const dt=a=>a.trim().toLowerCase().replaceAll(/\s+/g,"-").replaceAll(/[^\da-z-]/g,""),ut=n.memo(({open:a,onCancel:t,benchmark:m,onSuccess:D})=>{const{t:s}=$("eval"),{message:g}=_.useApp(),[l]=w.useForm(),[h,f]=n.useState(!1),[T,b]=n.useState(!1),v=I(S=>S.updateBenchmark),C=w.useWatch("name",l);return n.useEffect(()=>{a&&m&&(l.setFieldsValue({name:m.name,identifier:m.identifier,description:m.description||"",tags:m.tags||[]}),b(!1))},[a,m,l]),n.useEffect(()=>{!T&&C&&l.setFieldValue("identifier",dt(C))},[C,T,l]),e.jsx(oe,{allowFullscreen:!0,destroyOnHidden:!0,okButtonProps:{loading:h},okText:s("benchmark.edit.confirm"),open:a,title:s("benchmark.edit.title"),width:480,onCancel:S=>{l.resetFields(),b(!1),t?.(S)},onOk:async S=>{try{const d=await l.validateFields();f(!0),await v({id:m.id,identifier:d.identifier.trim(),name:d.name.trim(),description:d.description?.trim()||void 0,tags:d.tags?.length>0?d.tags:void 0}),g.success(s("benchmark.edit.success")),l.resetFields(),b(!1),t?.(S),D?.()}catch(d){if(d?.errorFields)return;g.error(s("benchmark.edit.error"))}finally{f(!1)}},children:e.jsxs(w,{form:l,layout:"vertical",style:{paddingBlock:16},children:[e.jsx(w.Item,{label:s("benchmark.create.name.label"),name:"name",rules:[{message:s("benchmark.create.nameRequired"),required:!0}],children:e.jsx(ae,{autoFocus:!0,placeholder:s("benchmark.create.name.placeholder")})}),e.jsx(w.Item,{label:s("benchmark.create.identifier.label"),name:"identifier",rules:[{message:s("benchmark.create.identifierRequired"),required:!0}],children:e.jsx(ae,{placeholder:s("benchmark.create.identifier.placeholder"),onChange:()=>b(!0)})}),e.jsx(w.Item,{label:s("benchmark.create.description.label"),name:"description",children:e.jsx(Ie,{placeholder:s("benchmark.create.description.placeholder"),rows:3})}),e.jsx(w.Item,{label:s("benchmark.create.tags.label"),name:"tags",style:{marginBottom:0},children:e.jsx(Fe,{mode:"tags",open:!1,placeholder:s("benchmark.create.tags.placeholder"),style:{width:"100%"},tokenSeparators:[",","，"," "]})})]})})}),se=[o.colorPrimary,o.colorSuccess,o.colorTextQuaternary],R=O(({css:a,cssVar:t})=>({bestPerformance:a`
    margin: 0;
