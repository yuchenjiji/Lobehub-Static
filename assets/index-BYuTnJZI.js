import{j as t}from"../vendor/vendor-motion-D2gXNOxm.js";import{a4 as $,F as g,y as M,h as S,j as C,bo as T,aA as L,B as w}from"./index-BzLMjSCA.js";import{M as B}from"./Modal-Ds-3kfE8.js";import{r as i}from"../vendor/vendor-emotion-D8kPrniB.js";import{S as _}from"./SearchBar-OYynhRFw.js";import{S as j}from"./index-BEQ9h0_F.js";import{q as N}from"./index-CkDfEvbt.js";import{A as k}from"./AgentSelectionEmpty-DZc-Pd-8.js";import{A as R}from"./index-C2Bs0zJB.js";import{C as F}from"./index-C1t6hsDK.js";import{a as z}from"./index-LrvwreA7.js";import{c as E}from"./react-g72HlZBO.js";import{bd as q}from"../vendor/vendor-icons-UxbXHH06.js";import{D}from"./index-C01IaG9-.js";const x=E((e,o)=>({clearSelection:()=>{e({selectedAgentIds:[]})},isSelected:n=>o().selectedAgentIds.includes(n),removeAgent:n=>{e(r=>({selectedAgentIds:r.selectedAgentIds.filter(l=>l!==n)}))},selectedAgentIds:[],setSelectedAgents:n=>{e({selectedAgentIds:n})},toggleAgent:n=>{e(r=>r.selectedAgentIds.includes(n)?{selectedAgentIds:r.selectedAgentIds.filter(s=>s!==n)}:{selectedAgentIds:[...r.selectedAgentIds,n]})}})),y=S(({css:e,cssVar:o})=>({item:e`
    cursor: pointer;
