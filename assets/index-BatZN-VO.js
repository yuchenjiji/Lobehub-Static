import{j as e}from"../vendor/vendor-motion-ksfQGfvU.js";import{j as $,az as _,e as Se,F as r,m as o,I as ne,B as E,h as O,aF as Y,y as J,C as ze,T as ke,L as Te,aJ as F,ap as we}from"./index-CMYT05q7.js";import{r as n}from"../vendor/vendor-emotion-D8kPrniB.js";import{u as I,a as Z}from"./store-BzIbBNxh.js";import"../vendor/vendor-es-toolkit-BI0f0n_g.js";import{e as De}from"./format-Bgr2c5k8.js";import"./providerConfig-CULHvVzb.js";import{I as ae}from"./Input-Bsu5U6hR.js";import{T as Ie}from"./TextArea-DVgV58En.js";import{M as oe}from"./Modal-oJrPIPIf.js";import{S as Fe}from"./Select-C8gP9TAw.js";import{F as w}from"./index-0QbDOjfg.js";import{f as Be,a as Re}from"./utils-DdCRt2d3.js";import{bc as le,U as Ne,z as V,cv as Ae,cx as Me,bG as ie,c as Pe,a9 as Ee,cy as We,bf as X,aZ as H,cz as Le,s as $e,cl as Oe,P as _e,Q as qe,bA as Qe,bD as Ue,bE as He,ak as Ge,bF as Je,a8 as Ke,bH as Ye,bI as Ze,bJ as Ve,bK as Xe}from"../vendor/vendor-icons-UxbXHH06.js";import{D as ce}from"./index-BGGqgB4o.js";import{B as de}from"./index-C1lbV_FP.js";import{g as et,d as U,T as tt,D as at,a as st,b as rt,c as ue,E as nt,R as ot}from"./RunCard-DNTFAeey.js";import{I as q}from"./index-CE444byf.js";import{N as lt}from"./index-ChgC1tc8.js";import{C as G}from"./index-CO7VfSZp.js";import{E as it}from"./Empty-qo9uUE3s.js";import{R as ct}from"./index-ZRvImO1y.js";import{r as pe}from"./selectors-D8FoU16Z.js";import"../i18n/i18n-zh-CN-X4QEO1fZ.js";import"../i18n/i18n-en-US-CeDxYD3m.js";import"./currency-iJxIWo9y.js";import"./style-2iT7JAdc.js";import"./Drawer-BnSrxxtK.js";import"./useForm-BVmJ0Qzv.js";import"./row-CtvuyPk8.js";import"./index-SXTJz0PZ.js";import"./LeftOutlined-BfgvCm-s.js";import"./Dropdown-BS2UaZBo.js";import"./index-C7P9lWxl.js";import"./EllipsisOutlined-DYUAsb50.js";import"./index-D3lkrP7o.js";import"./Addon-BGjVG8YH.js";import"./upload-DkitJq6i.js";import"./index-ChUgLrTM.js";import"./object-Cz6o-AEA.js";import"./_url-nNAm1vXA.js";import"./v4-BKrj-4V8.js";import"./index-Dvmhc-KT.js";import"./useBubbleLock-jaHyx18n.js";import"./Table--Q3u046g.js";import"./index-CQaM961Z.js";import"./scrollTo-7T40T9Iy.js";import"./Pagination-x4VxgUNe.js";import"./index-D-z1BbM-.js";import"./index-BHbNWXGR.js";import"./Input-3P5N-wN_.js";import"./index-bhRQV4zY.js";import"./index-B2ogSLFl.js";import"./DeleteOutlined-DFutYCzo.js";import"./EyeOutlined-BtMkzlfa.js";import"./progress-CL4Ocr3p.js";import"./AccordionItem-C3F4u5PH.js";import"./Block-D_uMJtCN.js";import"./index-CsJPAo_O.js";import"./index-Cug3zxp6.js";import"./index-BVXwUycr.js";import"./index-Cl-qfrWq.js";import"./PlusOutlined-1hX-xVf3.js";import"./StatusBadge-QHsndcXn.js";import"./TextArea-DBH2c_TT.js";import"./index-BqKUqcKT.js";const dt=a=>a.trim().toLowerCase().replaceAll(/\s+/g,"-").replaceAll(/[^\da-z-]/g,""),ut=n.memo(({open:a,onCancel:t,benchmark:m,onSuccess:D})=>{const{t:s}=$("eval"),{message:g}=_.useApp(),[l]=w.useForm(),[h,f]=n.useState(!1),[T,b]=n.useState(!1),v=I(S=>S.updateBenchmark),C=w.useWatch("name",l);return n.useEffect(()=>{a&&m&&(l.setFieldsValue({name:m.name,identifier:m.identifier,description:m.description||"",tags:m.tags||[]}),b(!1))},[a,m,l]),n.useEffect(()=>{!T&&C&&l.setFieldValue("identifier",dt(C))},[C,T,l]),e.jsx(oe,{allowFullscreen:!0,destroyOnHidden:!0,okButtonProps:{loading:h},okText:s("benchmark.edit.confirm"),open:a,title:s("benchmark.edit.title"),width:480,onCancel:S=>{l.resetFields(),b(!1),t?.(S)},onOk:async S=>{try{const d=await l.validateFields();f(!0),await v({id:m.id,identifier:d.identifier.trim(),name:d.name.trim(),description:d.description?.trim()||void 0,tags:d.tags?.length>0?d.tags:void 0}),g.success(s("benchmark.edit.success")),l.resetFields(),b(!1),t?.(S),D?.()}catch(d){if(d?.errorFields)return;g.error(s("benchmark.edit.error"))}finally{f(!1)}},children:e.jsxs(w,{form:l,layout:"vertical",style:{paddingBlock:16},children:[e.jsx(w.Item,{label:s("benchmark.create.name.label"),name:"name",rules:[{message:s("benchmark.create.nameRequired"),required:!0}],children:e.jsx(ae,{autoFocus:!0,placeholder:s("benchmark.create.name.placeholder")})}),e.jsx(w.Item,{label:s("benchmark.create.identifier.label"),name:"identifier",rules:[{message:s("benchmark.create.identifierRequired"),required:!0}],children:e.jsx(ae,{placeholder:s("benchmark.create.identifier.placeholder"),onChange:()=>b(!0)})}),e.jsx(w.Item,{label:s("benchmark.create.description.label"),name:"description",children:e.jsx(Ie,{placeholder:s("benchmark.create.description.placeholder"),rows:3})}),e.jsx(w.Item,{label:s("benchmark.create.tags.label"),name:"tags",style:{marginBottom:0},children:e.jsx(Fe,{mode:"tags",open:!1,placeholder:s("benchmark.create.tags.placeholder"),style:{width:"100%"},tokenSeparators:[",","，"," "]})})]})})}),se=[o.colorPrimary,o.colorSuccess,o.colorTextQuaternary],R=O(({css:a,cssVar:t})=>({bestPerformance:a`
    margin: 0;
