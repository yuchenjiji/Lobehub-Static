import{j as e}from"../vendor/vendor-motion-D2gXNOxm.js";import{j as $,az as _,e as Se,F as r,m as o,I as ne,B as E,h as O,aF as Y,y as J,C as ze,T as ke,L as Te,aJ as F,ap as we}from"./index-C3MhWRwW.js";import{r as n}from"../vendor/vendor-emotion-D8kPrniB.js";import{u as I,a as Z}from"./store-3tqHzH5n.js";import"../vendor/vendor-es-toolkit-BI0f0n_g.js";import{e as De}from"./format-Cx85KNuT.js";import"./providerConfig-CULHvVzb.js";import{I as ae}from"./Input-BXaztJrE.js";import{T as Ie}from"./TextArea-CuwKG1in.js";import{M as oe}from"./Modal-BollL6a2.js";import{S as Fe}from"./Select-C2V347XX.js";import{F as w}from"./index-WTx29NEN.js";import{f as Be,a as Re}from"./utils-DdCRt2d3.js";import{bc as le,U as Ne,z as V,cv as Ae,cx as Me,bG as ie,c as Pe,a9 as Ee,cy as We,bf as X,aZ as H,cz as Le,s as $e,cl as Oe,P as _e,Q as qe,bA as Qe,bD as Ue,bE as He,ak as Ge,bF as Je,a8 as Ke,bH as Ye,bI as Ze,bJ as Ve,bK as Xe}from"../vendor/vendor-icons-UxbXHH06.js";import{D as ce}from"./index-ftEhBFcG.js";import{B as de}from"./index-CP7Hkj46.js";import{g as et,d as U,T as tt,D as at,a as st,b as rt,c as ue,E as nt,R as ot}from"./RunCard-CORA8py2.js";import{I as q}from"./index-Cd_nmfIb.js";import{N as lt}from"./index-YWDweZLw.js";import{C as G}from"./index-qEacKvjY.js";import{E as it}from"./Empty-CbKvv5v_.js";import{R as ct}from"./index-oHBfpz4h.js";import{r as pe}from"./selectors-D8FoU16Z.js";import"../i18n/i18n-zh-CN-X4QEO1fZ.js";import"../i18n/i18n-en-US-CeDxYD3m.js";import"./currency-iJxIWo9y.js";import"./style-vTR6yg6m.js";import"./Drawer-Dg7-W9Cu.js";import"./useForm-DPwdx_OD.js";import"./row-B_axy4H6.js";import"./index-vP6kqrMr.js";import"./LeftOutlined-Cr1GaCJ1.js";import"./Dropdown-D-9hd1Se.js";import"./index-CuVXm4oj.js";import"./EllipsisOutlined-CYoYmLDM.js";import"./index-Czbumh_4.js";import"./Addon-slA_7lEm.js";import"./upload-BWFSyfS1.js";import"./index-C_ERzPwu.js";import"./object-Cz6o-AEA.js";import"./_url-jlGQHF6U.js";import"./v4-BKrj-4V8.js";import"./index-CZhiWFQT.js";import"./useBubbleLock-6kkEthu_.js";import"./Table-Bzy-CKv3.js";import"./index-DjpWy-xR.js";import"./scrollTo-Dm14Gpvp.js";import"./Pagination-CsDaLOTV.js";import"./index-BFqZVSGo.js";import"./index-Dog9QN_P.js";import"./Input-B3PErcWU.js";import"./index-Cnh4-bhC.js";import"./index-DqfyAi-K.js";import"./DeleteOutlined-DFutYCzo.js";import"./EyeOutlined-AIGl5rwF.js";import"./progress-Cj6jdcpT.js";import"./AccordionItem-Bkq7zOHj.js";import"./Block-CDNBuQmm.js";import"./index-Csk4ZgJo.js";import"./index-C0NpuzLN.js";import"./index-BQ6e2iVD.js";import"./index-B2jzqBuB.js";import"./PlusOutlined-DZH-kzJl.js";import"./StatusBadge-Dg_0Q0cb.js";import"./TextArea-DyF1XD5w.js";import"./index-Cw2YIoy3.js";const dt=a=>a.trim().toLowerCase().replaceAll(/\s+/g,"-").replaceAll(/[^\da-z-]/g,""),ut=n.memo(({open:a,onCancel:t,benchmark:m,onSuccess:D})=>{const{t:s}=$("eval"),{message:g}=_.useApp(),[l]=w.useForm(),[h,f]=n.useState(!1),[T,b]=n.useState(!1),v=I(S=>S.updateBenchmark),C=w.useWatch("name",l);return n.useEffect(()=>{a&&m&&(l.setFieldsValue({name:m.name,identifier:m.identifier,description:m.description||"",tags:m.tags||[]}),b(!1))},[a,m,l]),n.useEffect(()=>{!T&&C&&l.setFieldValue("identifier",dt(C))},[C,T,l]),e.jsx(oe,{allowFullscreen:!0,destroyOnHidden:!0,okButtonProps:{loading:h},okText:s("benchmark.edit.confirm"),open:a,title:s("benchmark.edit.title"),width:480,onCancel:S=>{l.resetFields(),b(!1),t?.(S)},onOk:async S=>{try{const d=await l.validateFields();f(!0),await v({id:m.id,identifier:d.identifier.trim(),name:d.name.trim(),description:d.description?.trim()||void 0,tags:d.tags?.length>0?d.tags:void 0}),g.success(s("benchmark.edit.success")),l.resetFields(),b(!1),t?.(S),D?.()}catch(d){if(d?.errorFields)return;g.error(s("benchmark.edit.error"))}finally{f(!1)}},children:e.jsxs(w,{form:l,layout:"vertical",style:{paddingBlock:16},children:[e.jsx(w.Item,{label:s("benchmark.create.name.label"),name:"name",rules:[{message:s("benchmark.create.nameRequired"),required:!0}],children:e.jsx(ae,{autoFocus:!0,placeholder:s("benchmark.create.name.placeholder")})}),e.jsx(w.Item,{label:s("benchmark.create.identifier.label"),name:"identifier",rules:[{message:s("benchmark.create.identifierRequired"),required:!0}],children:e.jsx(ae,{placeholder:s("benchmark.create.identifier.placeholder"),onChange:()=>b(!0)})}),e.jsx(w.Item,{label:s("benchmark.create.description.label"),name:"description",children:e.jsx(Ie,{placeholder:s("benchmark.create.description.placeholder"),rows:3})}),e.jsx(w.Item,{label:s("benchmark.create.tags.label"),name:"tags",style:{marginBottom:0},children:e.jsx(Fe,{mode:"tags",open:!1,placeholder:s("benchmark.create.tags.placeholder"),style:{width:"100%"},tokenSeparators:[",","，"," "]})})]})})}),se=[o.colorPrimary,o.colorSuccess,o.colorTextQuaternary],R=O(({css:a,cssVar:t})=>({bestPerformance:a`
    margin: 0;
