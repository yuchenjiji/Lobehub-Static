import{j as t}from"../vendor/vendor-motion-D2gXNOxm.js";import{a4 as $,F as g,y as M,h as S,j as C,bo as T,aA as L,B as w}from"./index-ByRn-atB.js";import{M as B}from"./Modal-xx0gJI_s.js";import{r as i}from"../vendor/vendor-emotion-D8kPrniB.js";import{S as _}from"./SearchBar-CNWCmjN1.js";import{S as j}from"./index-CN9SYExF.js";import{q as N}from"./index-f9W_nWWI.js";import{A as k}from"./AgentSelectionEmpty-D1VW5KAS.js";import{A as R}from"./index-DowEgs2W.js";import{C as F}from"./index-CIif9K1F.js";import{a as z}from"./index-C-ptIt_D.js";import{c as E}from"./react-BaqBwtci.js";import{bd as q}from"../vendor/vendor-icons-UxbXHH06.js";import{D}from"./index-PMHOEYBb.js";const x=E((e,o)=>({clearSelection:()=>{e({selectedAgentIds:[]})},isSelected:n=>o().selectedAgentIds.includes(n),removeAgent:n=>{e(r=>({selectedAgentIds:r.selectedAgentIds.filter(l=>l!==n)}))},selectedAgentIds:[],setSelectedAgents:n=>{e({selectedAgentIds:n})},toggleAgent:n=>{e(r=>r.selectedAgentIds.includes(n)?{selectedAgentIds:r.selectedAgentIds.filter(s=>s!==n)}:{selectedAgentIds:[...r.selectedAgentIds,n]})}})),y=S(({css:e,cssVar:o})=>({item:e`
    cursor: pointer;
