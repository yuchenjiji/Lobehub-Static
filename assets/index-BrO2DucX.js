import{fh as ae,J as H,b as L,h as T,j as w,l as b,y as A,i as M,dm as se,F as g,A as W,O as Z,P as ie,d as le,aX as ce,Y as de,f2 as ue,a3 as he,B as G,I as pe,m as y,a6 as me,ai as fe,g as ge,fi as xe,fj as ve,fk as ye,as as be,bj as we,bq as Se}from"./index-BTYm_psc.js";import{r as i}from"../vendor/vendor-emotion-D8kPrniB.js";import{f as ke,J as Te,j as B,k as Ie,D as Ae,K as D,u as J}from"./index-CBFoF9CZ.js";import{s as F,g as K}from"./index-CYYe1aUs.js";import{j as n}from"../vendor/vendor-motion-ksfQGfvU.js";import{P as Me}from"./PopoverGroup-CqsRroKk.js";import{B as je}from"./Block-CzvG4Myp.js";import{k as Ce}from"./Popover-DpTac6of.js";import{u as P,i as _}from"./index-CJwQyzfV.js";import{m as Pe}from"./markdownToTxt-D5ZfeaQN.js";import{c as N}from"./useOperationState-C-EuNUOY.js";import{df as _e,b2 as Ne,aZ as q,bd as Ee}from"../vendor/vendor-icons-UxbXHH06.js";import"./providerConfig-CULHvVzb.js";import{A as ze}from"./Alert-CT2DMXKt.js";import{A as Q}from"./index-C8i9ldt0.js";import{u as Y}from"./MarketAuthProvider-BW1Ohtpg.js";import{D as $e}from"./index-DdShcdJZ.js";import{u as We,p as Be}from"./useQueryParam-BkhxdwN-.js";import{D as De}from"./index-DOC2z7n8.js";import{p as V,P as ee}from"./router-BI5JjjR3.js";import{M as He}from"./Modal-DBI8gkBV.js";const Le=i.memo(()=>{const{analytics:e}=ae(),t=i.useCallback(()=>{const l=F.currentSession(K()),o=l?.id,c=F.defaultSessions(K()),r=H.showRightPanel(L.getState()),h=ke.activeDisplayMessages(Te());return{active_assistant:o==="inbox"?null:l?.meta?.title||null,has_chat_history:h.length>0,session_id:o||"inbox",sidebar_state:r?"expanded":"collapsed",visible_assistants_count:c.length}},[]);return i.useEffect(()=>{if(!e)return;const l=setTimeout(()=>{e.track({name:"main_page_view",properties:{...t(),spm:"main_page.interface.view"}})},1e3);return()=>clearTimeout(l)},[e,t]),null});Le.displayName="MainInterfaceTracker";const Re=T(({css:e,cssVar:t})=>({arrow:e`
    opacity: 0;
