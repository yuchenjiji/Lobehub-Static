import{j as t}from"../vendor/vendor-motion-D2gXNOxm.js";import{a4 as $,F as g,y as M,h as S,j as C,bo as T,aA as L,B as w}from"./index-L1Lg0j_R.js";import{M as B}from"./Modal-Bx2sdTxR.js";import{r as i}from"../vendor/vendor-emotion-D8kPrniB.js";import{S as _}from"./SearchBar-C_H3AQOr.js";import{S as j}from"./index-BwRIdDGx.js";import{q as N}from"./index-V30JT7YO.js";import{A as k}from"./AgentSelectionEmpty-CZvbZsY3.js";import{A as R}from"./index-cAAtdjfR.js";import{C as F}from"./index-DHxJX_dx.js";import{a as z}from"./index-CWrA6vf_.js";import{c as E}from"./react-CGIl6JLA.js";import{bd as q}from"../vendor/vendor-icons-UxbXHH06.js";import{D}from"./index-DE_k2j_3.js";const x=E((e,o)=>({clearSelection:()=>{e({selectedAgentIds:[]})},isSelected:n=>o().selectedAgentIds.includes(n),removeAgent:n=>{e(r=>({selectedAgentIds:r.selectedAgentIds.filter(l=>l!==n)}))},selectedAgentIds:[],setSelectedAgents:n=>{e({selectedAgentIds:n})},toggleAgent:n=>{e(r=>r.selectedAgentIds.includes(n)?{selectedAgentIds:r.selectedAgentIds.filter(s=>s!==n)}:{selectedAgentIds:[...r.selectedAgentIds,n]})}})),y=S(({css:e,cssVar:o})=>({item:e`
    cursor: pointer;
