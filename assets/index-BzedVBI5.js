import{j as e}from"../vendor/vendor-motion-D2gXNOxm.js";import{j as $,az as _,e as Se,F as r,m as o,I as ne,B as E,h as O,aF as Y,y as J,C as ze,T as ke,L as Te,aJ as F,ap as we}from"./index-CxFhYAo2.js";import{r as n}from"../vendor/vendor-emotion-D8kPrniB.js";import{u as I,a as Z}from"./store-Dz-lt6cO.js";import"../vendor/vendor-es-toolkit-BI0f0n_g.js";import{e as De}from"./format-D0Qv6cYp.js";import"./providerConfig-CULHvVzb.js";import{I as ae}from"./Input-u8jaZiRA.js";import{T as Ie}from"./TextArea-DPN1Sc-3.js";import{M as oe}from"./Modal-B1XJyP1p.js";import{S as Fe}from"./Select-BSny9PnD.js";import{F as w}from"./index-Cl1G5mMQ.js";import{f as Be,a as Re}from"./utils-DdCRt2d3.js";import{bc as le,U as Ne,z as V,cv as Ae,cx as Me,bG as ie,c as Pe,a9 as Ee,cy as We,bf as X,aZ as H,cz as Le,s as $e,cl as Oe,P as _e,Q as qe,bA as Qe,bD as Ue,bE as He,ak as Ge,bF as Je,a8 as Ke,bH as Ye,bI as Ze,bJ as Ve,bK as Xe}from"../vendor/vendor-icons-UxbXHH06.js";import{D as ce}from"./index-lIe7bLGH.js";import{B as de}from"./index-DysoUn50.js";import{g as et,d as U,T as tt,D as at,a as st,b as rt,c as ue,E as nt,R as ot}from"./RunCard-JbiysiIR.js";import{I as q}from"./index-5acnN7cQ.js";import{N as lt}from"./index-w17HivT8.js";import{C as G}from"./index-m1DzMwJm.js";import{E as it}from"./Empty-B9BtJqqC.js";import{R as ct}from"./index-DW4-l1yc.js";import{r as pe}from"./selectors-D8FoU16Z.js";import"../i18n/i18n-zh-CN-X4QEO1fZ.js";import"../i18n/i18n-en-US-CeDxYD3m.js";import"./currency-iJxIWo9y.js";import"./style-X532KRMn.js";import"./Drawer-CuZpVabz.js";import"./useForm-HWTQtc-7.js";import"./row-CeMEQmHp.js";import"./index-BEfPTCCM.js";import"./LeftOutlined-DHfY1I1O.js";import"./Dropdown-CHoHmfwf.js";import"./index-CLF6VyY8.js";import"./EllipsisOutlined-CgBu5-_B.js";import"./index-BHuH8m9S.js";import"./Addon-BuThrggK.js";import"./upload-wDTB5urN.js";import"./index-D49suqG7.js";import"./object-Cz6o-AEA.js";import"./_url-B_Ps5E0u.js";import"./v4-BKrj-4V8.js";import"./index-7M7Ncvpy.js";import"./useBubbleLock-6kkEthu_.js";import"./Table-nMMK09rp.js";import"./index-C927X2WX.js";import"./scrollTo-CW5sb216.js";import"./Pagination-DRJtjw6J.js";import"./index-dQAkg_qZ.js";import"./index-BlkyP1dS.js";import"./Input-B01-d9th.js";import"./index-CXsw29Yu.js";import"./index-Dy30C_cm.js";import"./DeleteOutlined-DFutYCzo.js";import"./EyeOutlined-4c7jxV8s.js";import"./progress-B1oVYDks.js";import"./AccordionItem-ro_vY_hW.js";import"./Block-DQnQVMG7.js";import"./index-CGSYz0Bu.js";import"./index-P8QfyMmD.js";import"./index-B2xRHnSv.js";import"./index-Bj7PHkD1.js";import"./PlusOutlined-DBn6uUOO.js";import"./StatusBadge-BZ8u_gNW.js";import"./TextArea-DxPfTy1n.js";import"./index-BY1HgoII.js";const dt=a=>a.trim().toLowerCase().replaceAll(/\s+/g,"-").replaceAll(/[^\da-z-]/g,""),ut=n.memo(({open:a,onCancel:t,benchmark:m,onSuccess:D})=>{const{t:s}=$("eval"),{message:g}=_.useApp(),[l]=w.useForm(),[h,f]=n.useState(!1),[T,b]=n.useState(!1),v=I(S=>S.updateBenchmark),C=w.useWatch("name",l);return n.useEffect(()=>{a&&m&&(l.setFieldsValue({name:m.name,identifier:m.identifier,description:m.description||"",tags:m.tags||[]}),b(!1))},[a,m,l]),n.useEffect(()=>{!T&&C&&l.setFieldValue("identifier",dt(C))},[C,T,l]),e.jsx(oe,{allowFullscreen:!0,destroyOnHidden:!0,okButtonProps:{loading:h},okText:s("benchmark.edit.confirm"),open:a,title:s("benchmark.edit.title"),width:480,onCancel:S=>{l.resetFields(),b(!1),t?.(S)},onOk:async S=>{try{const d=await l.validateFields();f(!0),await v({id:m.id,identifier:d.identifier.trim(),name:d.name.trim(),description:d.description?.trim()||void 0,tags:d.tags?.length>0?d.tags:void 0}),g.success(s("benchmark.edit.success")),l.resetFields(),b(!1),t?.(S),D?.()}catch(d){if(d?.errorFields)return;g.error(s("benchmark.edit.error"))}finally{f(!1)}},children:e.jsxs(w,{form:l,layout:"vertical",style:{paddingBlock:16},children:[e.jsx(w.Item,{label:s("benchmark.create.name.label"),name:"name",rules:[{message:s("benchmark.create.nameRequired"),required:!0}],children:e.jsx(ae,{autoFocus:!0,placeholder:s("benchmark.create.name.placeholder")})}),e.jsx(w.Item,{label:s("benchmark.create.identifier.label"),name:"identifier",rules:[{message:s("benchmark.create.identifierRequired"),required:!0}],children:e.jsx(ae,{placeholder:s("benchmark.create.identifier.placeholder"),onChange:()=>b(!0)})}),e.jsx(w.Item,{label:s("benchmark.create.description.label"),name:"description",children:e.jsx(Ie,{placeholder:s("benchmark.create.description.placeholder"),rows:3})}),e.jsx(w.Item,{label:s("benchmark.create.tags.label"),name:"tags",style:{marginBottom:0},children:e.jsx(Fe,{mode:"tags",open:!1,placeholder:s("benchmark.create.tags.placeholder"),style:{width:"100%"},tokenSeparators:[",","，"," "]})})]})})}),se=[o.colorPrimary,o.colorSuccess,o.colorTextQuaternary],R=O(({css:a,cssVar:t})=>({bestPerformance:a`
    margin: 0;
