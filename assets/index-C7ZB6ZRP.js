import{j as t}from"../vendor/vendor-motion-D2gXNOxm.js";import{a4 as $,F as g,y as M,h as S,j as C,bo as T,aA as L,B as w}from"./index-DTW0VVHo.js";import{M as B}from"./Modal-mcqESmcN.js";import{r as i}from"../vendor/vendor-emotion-D8kPrniB.js";import{S as _}from"./SearchBar-C3pp9bg7.js";import{S as j}from"./index-iEwlIla2.js";import{q as N}from"./index-Blxz1U9m.js";import{A as k}from"./AgentSelectionEmpty-BXtdK5vX.js";import{A as R}from"./index-D0uAch6x.js";import{C as F}from"./index-LlemoIda.js";import{a as z}from"./index-DvfNfOYS.js";import{c as E}from"./react-BC7KAbHa.js";import{bd as q}from"../vendor/vendor-icons-UxbXHH06.js";import{D}from"./index-B-SAUIkD.js";const x=E((e,o)=>({clearSelection:()=>{e({selectedAgentIds:[]})},isSelected:n=>o().selectedAgentIds.includes(n),removeAgent:n=>{e(r=>({selectedAgentIds:r.selectedAgentIds.filter(l=>l!==n)}))},selectedAgentIds:[],setSelectedAgents:n=>{e({selectedAgentIds:n})},toggleAgent:n=>{e(r=>r.selectedAgentIds.includes(n)?{selectedAgentIds:r.selectedAgentIds.filter(s=>s!==n)}:{selectedAgentIds:[...r.selectedAgentIds,n]})}})),y=S(({css:e,cssVar:o})=>({item:e`
    cursor: pointer;
