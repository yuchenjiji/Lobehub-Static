import{j as t}from"../vendor/vendor-motion-D2gXNOxm.js";import{a4 as $,F as g,y as M,h as S,j as C,bo as T,aA as L,B as w}from"./index-Br4NLp7q.js";import{M as B}from"./Modal-CWneoRm6.js";import{r as i}from"../vendor/vendor-emotion-D8kPrniB.js";import{S as _}from"./SearchBar-BgNRIkwM.js";import{S as j}from"./index-KfEcV1B0.js";import{q as N}from"./index-Z6aE2yre.js";import{A as k}from"./AgentSelectionEmpty-ChEC_CYe.js";import{A as R}from"./index-CWb559BK.js";import{C as F}from"./index-CkOVzRk8.js";import{a as z}from"./index-DurWk2tP.js";import{c as E}from"./react-B-vxS5Yx.js";import{bd as q}from"../vendor/vendor-icons-UxbXHH06.js";import{D}from"./index-Zb5TBIvJ.js";const x=E((e,o)=>({clearSelection:()=>{e({selectedAgentIds:[]})},isSelected:n=>o().selectedAgentIds.includes(n),removeAgent:n=>{e(r=>({selectedAgentIds:r.selectedAgentIds.filter(l=>l!==n)}))},selectedAgentIds:[],setSelectedAgents:n=>{e({selectedAgentIds:n})},toggleAgent:n=>{e(r=>r.selectedAgentIds.includes(n)?{selectedAgentIds:r.selectedAgentIds.filter(s=>s!==n)}:{selectedAgentIds:[...r.selectedAgentIds,n]})}})),y=S(({css:e,cssVar:o})=>({item:e`
    cursor: pointer;
