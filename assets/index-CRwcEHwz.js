import{j as e}from"../vendor/vendor-motion-ksfQGfvU.js";import{j as $,az as _,e as Se,F as r,m as o,I as ne,B as E,h as O,aF as Y,y as J,C as ze,T as ke,L as Te,aJ as F,ap as we}from"./index-BTYm_psc.js";import{r as n}from"../vendor/vendor-emotion-D8kPrniB.js";import{u as I,a as Z}from"./store-BXltjjwL.js";import"../vendor/vendor-es-toolkit-BI0f0n_g.js";import{e as De}from"./format-tdCMj1QR.js";import"./providerConfig-CULHvVzb.js";import{I as ae}from"./Input-DlQGRlQJ.js";import{T as Ie}from"./TextArea-B0eAnq5_.js";import{M as oe}from"./Modal-DBI8gkBV.js";import{S as Fe}from"./Select-g02uronB.js";import{F as w}from"./index-A8s_dT6W.js";import{f as Be,a as Re}from"./utils-DdCRt2d3.js";import{bc as le,U as Ne,z as V,cv as Ae,cx as Me,bG as ie,c as Pe,a9 as Ee,cy as We,bf as X,aZ as H,cz as Le,s as $e,cl as Oe,P as _e,Q as qe,bA as Qe,bD as Ue,bE as He,ak as Ge,bF as Je,a8 as Ke,bH as Ye,bI as Ze,bJ as Ve,bK as Xe}from"../vendor/vendor-icons-UxbXHH06.js";import{D as ce}from"./index-Tm2VBgSy.js";import{B as de}from"./index-C7clpSzY.js";import{g as et,d as U,T as tt,D as at,a as st,b as rt,c as ue,E as nt,R as ot}from"./RunCard-BI9Kxg5I.js";import{I as q}from"./index-Xifu1Le5.js";import{N as lt}from"./index-DdHsYMzg.js";import{C as G}from"./index-PEVFQbiJ.js";import{E as it}from"./Empty-D-59r-gH.js";import{R as ct}from"./index-BX8EqfLk.js";import{r as pe}from"./selectors-D8FoU16Z.js";import"../i18n/i18n-zh-CN-X4QEO1fZ.js";import"../i18n/i18n-en-US-CeDxYD3m.js";import"./currency-iJxIWo9y.js";import"./style-DjFM5MBF.js";import"./Drawer-BhNvJ4HY.js";import"./useForm-CaKsFAlO.js";import"./row-l60Sfv2K.js";import"./index-BKs8zWty.js";import"./LeftOutlined-Dycim1qq.js";import"./Dropdown-BZQBS7VM.js";import"./index-ClYTx8vz.js";import"./EllipsisOutlined-DpgiB_Fq.js";import"./index-B4Hvwfb1.js";import"./Addon-D4htfwbH.js";import"./upload-C0bB3V3X.js";import"./index-BBk0XYR7.js";import"./object-Cz6o-AEA.js";import"./_url-HpanO-dJ.js";import"./v4-BKrj-4V8.js";import"./index-DDZMbJR2.js";import"./useBubbleLock-jaHyx18n.js";import"./Table-DWWqLwQP.js";import"./index-3VupkVrs.js";import"./scrollTo-CjA55vJc.js";import"./Pagination-1VxNBExY.js";import"./index-L0S29iN_.js";import"./index-BLXBbZqI.js";import"./Input-Bdrgk0hH.js";import"./index-DdShcdJZ.js";import"./index-BtQ1pvtw.js";import"./DeleteOutlined-DFutYCzo.js";import"./EyeOutlined-i2LDjxZj.js";import"./progress-LU_hV_iI.js";import"./AccordionItem-DvkP7Rbk.js";import"./Block-CzvG4Myp.js";import"./index-C8i9ldt0.js";import"./index-CrDNjW5_.js";import"./index-CMb12WLx.js";import"./index-B8jCtHyV.js";import"./PlusOutlined-BjOizlV_.js";import"./StatusBadge-85eww972.js";import"./TextArea-DMrmu7l-.js";import"./index-BryhekM3.js";const dt=a=>a.trim().toLowerCase().replaceAll(/\s+/g,"-").replaceAll(/[^\da-z-]/g,""),ut=n.memo(({open:a,onCancel:t,benchmark:m,onSuccess:D})=>{const{t:s}=$("eval"),{message:g}=_.useApp(),[l]=w.useForm(),[h,f]=n.useState(!1),[T,b]=n.useState(!1),v=I(S=>S.updateBenchmark),C=w.useWatch("name",l);return n.useEffect(()=>{a&&m&&(l.setFieldsValue({name:m.name,identifier:m.identifier,description:m.description||"",tags:m.tags||[]}),b(!1))},[a,m,l]),n.useEffect(()=>{!T&&C&&l.setFieldValue("identifier",dt(C))},[C,T,l]),e.jsx(oe,{allowFullscreen:!0,destroyOnHidden:!0,okButtonProps:{loading:h},okText:s("benchmark.edit.confirm"),open:a,title:s("benchmark.edit.title"),width:480,onCancel:S=>{l.resetFields(),b(!1),t?.(S)},onOk:async S=>{try{const d=await l.validateFields();f(!0),await v({id:m.id,identifier:d.identifier.trim(),name:d.name.trim(),description:d.description?.trim()||void 0,tags:d.tags?.length>0?d.tags:void 0}),g.success(s("benchmark.edit.success")),l.resetFields(),b(!1),t?.(S),D?.()}catch(d){if(d?.errorFields)return;g.error(s("benchmark.edit.error"))}finally{f(!1)}},children:e.jsxs(w,{form:l,layout:"vertical",style:{paddingBlock:16},children:[e.jsx(w.Item,{label:s("benchmark.create.name.label"),name:"name",rules:[{message:s("benchmark.create.nameRequired"),required:!0}],children:e.jsx(ae,{autoFocus:!0,placeholder:s("benchmark.create.name.placeholder")})}),e.jsx(w.Item,{label:s("benchmark.create.identifier.label"),name:"identifier",rules:[{message:s("benchmark.create.identifierRequired"),required:!0}],children:e.jsx(ae,{placeholder:s("benchmark.create.identifier.placeholder"),onChange:()=>b(!0)})}),e.jsx(w.Item,{label:s("benchmark.create.description.label"),name:"description",children:e.jsx(Ie,{placeholder:s("benchmark.create.description.placeholder"),rows:3})}),e.jsx(w.Item,{label:s("benchmark.create.tags.label"),name:"tags",style:{marginBottom:0},children:e.jsx(Fe,{mode:"tags",open:!1,placeholder:s("benchmark.create.tags.placeholder"),style:{width:"100%"},tokenSeparators:[",","，"," "]})})]})})}),se=[o.colorPrimary,o.colorSuccess,o.colorTextQuaternary],R=O(({css:a,cssVar:t})=>({bestPerformance:a`
    margin: 0;
