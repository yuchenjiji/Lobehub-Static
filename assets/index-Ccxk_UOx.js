import{j as t}from"../vendor/vendor-motion-D2gXNOxm.js";import{a4 as $,F as g,y as M,h as S,j as C,bo as T,aA as L,B as w}from"./index-C5zbgvwz.js";import{M as B}from"./Modal-Ds6YT6ie.js";import{r as i}from"../vendor/vendor-emotion-D8kPrniB.js";import{S as _}from"./SearchBar-DQcHaBuC.js";import{S as j}from"./index-DU0CwqWq.js";import{q as N}from"./index-Cu4huSpE.js";import{A as k}from"./AgentSelectionEmpty-DI4Th-6G.js";import{A as R}from"./index-Bv_c-ZRT.js";import{C as F}from"./index-Xswk1Gwv.js";import{a as z}from"./index-YmyZjXcq.js";import{c as E}from"./react-ITfwr6qc.js";import{bd as q}from"../vendor/vendor-icons-UxbXHH06.js";import{D}from"./index-CXdQUuZG.js";const x=E((e,o)=>({clearSelection:()=>{e({selectedAgentIds:[]})},isSelected:n=>o().selectedAgentIds.includes(n),removeAgent:n=>{e(r=>({selectedAgentIds:r.selectedAgentIds.filter(l=>l!==n)}))},selectedAgentIds:[],setSelectedAgents:n=>{e({selectedAgentIds:n})},toggleAgent:n=>{e(r=>r.selectedAgentIds.includes(n)?{selectedAgentIds:r.selectedAgentIds.filter(s=>s!==n)}:{selectedAgentIds:[...r.selectedAgentIds,n]})}})),y=S(({css:e,cssVar:o})=>({item:e`
    cursor: pointer;
