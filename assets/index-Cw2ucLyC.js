import{j as t}from"../vendor/vendor-motion-ksfQGfvU.js";import{a4 as $,F as g,y as M,h as S,j as C,bo as T,aA as L,B as w}from"./index-CMYT05q7.js";import{M as B}from"./Modal-oJrPIPIf.js";import{r as i}from"../vendor/vendor-emotion-D8kPrniB.js";import{S as _}from"./SearchBar-B2SlL0zJ.js";import{S as j}from"./index-DrF-suok.js";import{q as N}from"./index-BP_P4qV8.js";import{A as k}from"./AgentSelectionEmpty-CUrBM08y.js";import{A as R}from"./index-CsJPAo_O.js";import{C as F}from"./index-CwkSIyf2.js";import{a as z}from"./index-r2AEK1zF.js";import{c as E}from"./react-CMa4dfTf.js";import{bd as q}from"../vendor/vendor-icons-UxbXHH06.js";import{D}from"./index-bhRQV4zY.js";const x=E((e,o)=>({clearSelection:()=>{e({selectedAgentIds:[]})},isSelected:n=>o().selectedAgentIds.includes(n),removeAgent:n=>{e(r=>({selectedAgentIds:r.selectedAgentIds.filter(l=>l!==n)}))},selectedAgentIds:[],setSelectedAgents:n=>{e({selectedAgentIds:n})},toggleAgent:n=>{e(r=>r.selectedAgentIds.includes(n)?{selectedAgentIds:r.selectedAgentIds.filter(s=>s!==n)}:{selectedAgentIds:[...r.selectedAgentIds,n]})}})),y=S(({css:e,cssVar:o})=>({item:e`
    cursor: pointer;
