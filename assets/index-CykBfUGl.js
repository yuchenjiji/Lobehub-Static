import{j as t}from"../vendor/vendor-motion-D2gXNOxm.js";import{a4 as $,F as g,y as M,h as S,j as C,bo as T,aA as L,B as w}from"./index-CxFhYAo2.js";import{M as B}from"./Modal-B1XJyP1p.js";import{r as i}from"../vendor/vendor-emotion-D8kPrniB.js";import{S as _}from"./SearchBar-tHEEXd4c.js";import{S as j}from"./index-JbrybBbJ.js";import{q as N}from"./index-DCkW8mxV.js";import{A as k}from"./AgentSelectionEmpty-D0HNfe_u.js";import{A as R}from"./index-CGSYz0Bu.js";import{C as F}from"./index-Cp4fwUqU.js";import{a as z}from"./index-BdpzF0Tx.js";import{c as E}from"./react-bAHOtvu0.js";import{bd as q}from"../vendor/vendor-icons-UxbXHH06.js";import{D}from"./index-CXsw29Yu.js";const x=E((e,o)=>({clearSelection:()=>{e({selectedAgentIds:[]})},isSelected:n=>o().selectedAgentIds.includes(n),removeAgent:n=>{e(r=>({selectedAgentIds:r.selectedAgentIds.filter(l=>l!==n)}))},selectedAgentIds:[],setSelectedAgents:n=>{e({selectedAgentIds:n})},toggleAgent:n=>{e(r=>r.selectedAgentIds.includes(n)?{selectedAgentIds:r.selectedAgentIds.filter(s=>s!==n)}:{selectedAgentIds:[...r.selectedAgentIds,n]})}})),y=S(({css:e,cssVar:o})=>({item:e`
    cursor: pointer;
