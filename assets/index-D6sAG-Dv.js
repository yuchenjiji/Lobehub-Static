import{j as e}from"../vendor/vendor-motion-D2gXNOxm.js";import{G as v}from"./Grid-TsyTblsj.js";import{j as h,C as z,ax as b,I as x,m as w,e as M,br as T,F as s,L as k,y as m,a9 as I,T as _,h as $}from"./index-CnQvfPte.js";import{r as n}from"../vendor/vendor-emotion-D8kPrniB.js";import{E as C}from"./Empty-BUYZYMe-.js";import{bh as N,aO as P,bi as S,bj as B,x as D,bk as E,I as L,bl as F,au as G,a9 as O}from"../vendor/vendor-icons-UxbXHH06.js";import{B as R}from"./Block-CMBYIh5M.js";import{k as W}from"./Popover-4ATUxUSU.js";import{a as q}from"./index-XwmtYPvw.js";import{P as A}from"./PublishedTime-GXQcP_Ys.js";import{s as H}from"../vendor/vendor-es-toolkit-BI0f0n_g.js";import{M as J}from"./index-CJV-jP_3.js";import{P as p}from"./index-ZiplUfYl.js";const u=n.memo(({search:t,...o})=>{const{t:a}=h("discover");return e.jsx(z,{height:"100%",style:{minHeight:"50vh"},width:"100%",children:e.jsx(C,{description:a(t?"models.empty.search":"models.empty.description"),icon:N,title:t?void 0:a("models.empty.title"),type:t?"default":"page",descriptionProps:{fontSize:14},style:{maxWidth:400},...o})})});u.displayName="ModelEmpty";const K={chat:G,embedding:F,image:L,realtime:E,stt:D,text2music:B,tts:S,video:P},Q=n.memo(({type:t,size:o=20})=>e.jsx(b,{title:`${H(t)} Model`,children:e.jsx(x,{color:w.colorTextDescription,icon:K?.[t],size:o})})),r=$(({css:t,cssVar:o})=>({author:t`
