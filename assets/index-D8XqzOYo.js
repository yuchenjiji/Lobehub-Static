import{j as e}from"../vendor/vendor-motion-D2gXNOxm.js";import{j as $,az as _,e as Se,F as r,m as o,I as ne,B as E,h as O,aF as Y,y as J,C as ze,T as ke,L as Te,aJ as F,ap as we}from"./index-BlXf1DT_.js";import{r as n}from"../vendor/vendor-emotion-D8kPrniB.js";import{u as I,a as Z}from"./store-CreeXmWz.js";import"../vendor/vendor-es-toolkit-BI0f0n_g.js";import{e as De}from"./format-xziyf958.js";import"./providerConfig-CULHvVzb.js";import{I as ae}from"./Input-DpAEB2EK.js";import{T as Ie}from"./TextArea-F2JUBBOu.js";import{M as oe}from"./Modal-BRe8tRgU.js";import{S as Fe}from"./Select-D-ocnjYy.js";import{F as w}from"./index-ConHfvRV.js";import{f as Be,a as Re}from"./utils-DdCRt2d3.js";import{bc as le,U as Ne,z as V,cv as Ae,cx as Me,bG as ie,c as Pe,a9 as Ee,cy as We,bf as X,aZ as H,cz as Le,s as $e,cl as Oe,P as _e,Q as qe,bA as Qe,bD as Ue,bE as He,ak as Ge,bF as Je,a8 as Ke,bH as Ye,bI as Ze,bJ as Ve,bK as Xe}from"../vendor/vendor-icons-UxbXHH06.js";import{D as ce}from"./index-DIcE_cbo.js";import{B as de}from"./index-CFfV9a5X.js";import{g as et,d as U,T as tt,D as at,a as st,b as rt,c as ue,E as nt,R as ot}from"./RunCard-DH5ipEuC.js";import{I as q}from"./index-ClcteeR3.js";import{N as lt}from"./index-BVHDy0Me.js";import{C as G}from"./index-DdeyN3Yo.js";import{E as it}from"./Empty-DYKpC2V7.js";import{R as ct}from"./index-BaUhtSbM.js";import{r as pe}from"./selectors-D8FoU16Z.js";import"../i18n/i18n-zh-CN-X4QEO1fZ.js";import"../i18n/i18n-en-US-CeDxYD3m.js";import"./currency-iJxIWo9y.js";import"./style-Cmt4ulUw.js";import"./Drawer-CAiWKI7n.js";import"./useForm-Buul26ph.js";import"./row-DxCUW653.js";import"./index-Ch2yGWrP.js";import"./LeftOutlined-D7lAaNRY.js";import"./Dropdown-MbmpwoFb.js";import"./index-CYHE1iCL.js";import"./EllipsisOutlined-DX6cMWFS.js";import"./index-BaIKQ5wY.js";import"./Addon-MwbA8QIw.js";import"./upload-DSSiM6vA.js";import"./index-BttaoKH9.js";import"./object-Cz6o-AEA.js";import"./_url-BON6RRit.js";import"./v4-BKrj-4V8.js";import"./index-B41xVdsr.js";import"./useBubbleLock-6kkEthu_.js";import"./Table-CY7MYqTN.js";import"./index-Ly5lSnEu.js";import"./scrollTo-C_MlXhSM.js";import"./Pagination-fyT87F3p.js";import"./index-FJdICAgV.js";import"./index-2KKJpWiq.js";import"./Input-BLU0gM8q.js";import"./index-C74cxLxW.js";import"./index-PZz-fCmf.js";import"./DeleteOutlined-DFutYCzo.js";import"./EyeOutlined-D6vI7Hb5.js";import"./progress-krb-4YK2.js";import"./AccordionItem-mRPR6zhm.js";import"./Block-CaxDTBwJ.js";import"./index-QeoY0oy6.js";import"./index-CZ2N4Hp5.js";import"./index-CptiTFY4.js";import"./index-kdBA8w10.js";import"./PlusOutlined-C2s-yQzb.js";import"./StatusBadge-CmiuNeex.js";import"./TextArea-AfgZNbfB.js";import"./index-C-vzoELR.js";const dt=a=>a.trim().toLowerCase().replaceAll(/\s+/g,"-").replaceAll(/[^\da-z-]/g,""),ut=n.memo(({open:a,onCancel:t,benchmark:m,onSuccess:D})=>{const{t:s}=$("eval"),{message:g}=_.useApp(),[l]=w.useForm(),[h,f]=n.useState(!1),[T,b]=n.useState(!1),v=I(S=>S.updateBenchmark),C=w.useWatch("name",l);return n.useEffect(()=>{a&&m&&(l.setFieldsValue({name:m.name,identifier:m.identifier,description:m.description||"",tags:m.tags||[]}),b(!1))},[a,m,l]),n.useEffect(()=>{!T&&C&&l.setFieldValue("identifier",dt(C))},[C,T,l]),e.jsx(oe,{allowFullscreen:!0,destroyOnHidden:!0,okButtonProps:{loading:h},okText:s("benchmark.edit.confirm"),open:a,title:s("benchmark.edit.title"),width:480,onCancel:S=>{l.resetFields(),b(!1),t?.(S)},onOk:async S=>{try{const d=await l.validateFields();f(!0),await v({id:m.id,identifier:d.identifier.trim(),name:d.name.trim(),description:d.description?.trim()||void 0,tags:d.tags?.length>0?d.tags:void 0}),g.success(s("benchmark.edit.success")),l.resetFields(),b(!1),t?.(S),D?.()}catch(d){if(d?.errorFields)return;g.error(s("benchmark.edit.error"))}finally{f(!1)}},children:e.jsxs(w,{form:l,layout:"vertical",style:{paddingBlock:16},children:[e.jsx(w.Item,{label:s("benchmark.create.name.label"),name:"name",rules:[{message:s("benchmark.create.nameRequired"),required:!0}],children:e.jsx(ae,{autoFocus:!0,placeholder:s("benchmark.create.name.placeholder")})}),e.jsx(w.Item,{label:s("benchmark.create.identifier.label"),name:"identifier",rules:[{message:s("benchmark.create.identifierRequired"),required:!0}],children:e.jsx(ae,{placeholder:s("benchmark.create.identifier.placeholder"),onChange:()=>b(!0)})}),e.jsx(w.Item,{label:s("benchmark.create.description.label"),name:"description",children:e.jsx(Ie,{placeholder:s("benchmark.create.description.placeholder"),rows:3})}),e.jsx(w.Item,{label:s("benchmark.create.tags.label"),name:"tags",style:{marginBottom:0},children:e.jsx(Fe,{mode:"tags",open:!1,placeholder:s("benchmark.create.tags.placeholder"),style:{width:"100%"},tokenSeparators:[",","，"," "]})})]})})}),se=[o.colorPrimary,o.colorSuccess,o.colorTextQuaternary],R=O(({css:a,cssVar:t})=>({bestPerformance:a`
    margin: 0;
