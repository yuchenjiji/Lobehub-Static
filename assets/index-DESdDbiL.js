import{j as e}from"../vendor/vendor-motion-D2gXNOxm.js";import{j as $,az as _,e as Se,F as r,m as o,I as ne,B as E,h as O,aF as Y,y as J,C as ze,T as ke,L as Te,aJ as F,ap as we}from"./index-C5zbgvwz.js";import{r as n}from"../vendor/vendor-emotion-D8kPrniB.js";import{u as I,a as Z}from"./store-DXsvhEku.js";import"../vendor/vendor-es-toolkit-BI0f0n_g.js";import{e as De}from"./format-BZrVXdNl.js";import"./providerConfig-CULHvVzb.js";import{I as ae}from"./Input-BZlUNiNv.js";import{T as Ie}from"./TextArea-DbsbdBE9.js";import{M as oe}from"./Modal-Ds6YT6ie.js";import{S as Fe}from"./Select-B8U_5nc0.js";import{F as w}from"./index-BJfhmekG.js";import{f as Be,a as Re}from"./utils-DdCRt2d3.js";import{bc as le,U as Ne,z as V,cv as Ae,cx as Me,bG as ie,c as Pe,a9 as Ee,cy as We,bf as X,aZ as H,cz as Le,s as $e,cl as Oe,P as _e,Q as qe,bA as Qe,bD as Ue,bE as He,ak as Ge,bF as Je,a8 as Ke,bH as Ye,bI as Ze,bJ as Ve,bK as Xe}from"../vendor/vendor-icons-UxbXHH06.js";import{D as ce}from"./index-CtGcNZdU.js";import{B as de}from"./index-DcbrbIty.js";import{g as et,d as U,T as tt,D as at,a as st,b as rt,c as ue,E as nt,R as ot}from"./RunCard-P7htj_I-.js";import{I as q}from"./index-DQg4GssT.js";import{N as lt}from"./index-CtJd-mJL.js";import{C as G}from"./index-D8-C-Fr0.js";import{E as it}from"./Empty-B9D0D8Mx.js";import{R as ct}from"./index-DfRj-Mcd.js";import{r as pe}from"./selectors-D8FoU16Z.js";import"../i18n/i18n-zh-CN-X4QEO1fZ.js";import"../i18n/i18n-en-US-CeDxYD3m.js";import"./currency-iJxIWo9y.js";import"./style-Cc6Cvg0i.js";import"./Drawer-GxKHEtZR.js";import"./useForm-CZNop9z3.js";import"./row-CNC2zMuA.js";import"./index-Ar4KhFnc.js";import"./LeftOutlined-BedGXtja.js";import"./Dropdown-_bybfa42.js";import"./index-BcfjwlL0.js";import"./EllipsisOutlined-ClapHBS-.js";import"./index-BLr7vUX7.js";import"./Addon-DYHeKYea.js";import"./upload-ccM65yWY.js";import"./index-DG7v53ec.js";import"./object-Cz6o-AEA.js";import"./_url-CCpiR_bI.js";import"./v4-BKrj-4V8.js";import"./index-Bob_iapA.js";import"./useBubbleLock-6kkEthu_.js";import"./Table-BNwJN8Kx.js";import"./index-C0si2a-U.js";import"./scrollTo-EQcPlhuD.js";import"./Pagination-OpTQ2CFZ.js";import"./index-Dd5DHJV3.js";import"./index-CyXqTsJB.js";import"./Input-B2YxDM_u.js";import"./index-CXdQUuZG.js";import"./index-BYRQ3E7k.js";import"./DeleteOutlined-DFutYCzo.js";import"./EyeOutlined-B7LKANr7.js";import"./progress-CcKoY2f1.js";import"./AccordionItem-C9CEd-kR.js";import"./Block-UAMP4nj4.js";import"./index-Bv_c-ZRT.js";import"./index-D8P_Ja1q.js";import"./index-DL5m1iHk.js";import"./index-BDe-zZ3h.js";import"./PlusOutlined-YbQX6OW4.js";import"./StatusBadge-C3bgj5js.js";import"./TextArea-ChyWBsMD.js";import"./index-Dw6s47us.js";const dt=a=>a.trim().toLowerCase().replaceAll(/\s+/g,"-").replaceAll(/[^\da-z-]/g,""),ut=n.memo(({open:a,onCancel:t,benchmark:m,onSuccess:D})=>{const{t:s}=$("eval"),{message:g}=_.useApp(),[l]=w.useForm(),[h,f]=n.useState(!1),[T,b]=n.useState(!1),v=I(S=>S.updateBenchmark),C=w.useWatch("name",l);return n.useEffect(()=>{a&&m&&(l.setFieldsValue({name:m.name,identifier:m.identifier,description:m.description||"",tags:m.tags||[]}),b(!1))},[a,m,l]),n.useEffect(()=>{!T&&C&&l.setFieldValue("identifier",dt(C))},[C,T,l]),e.jsx(oe,{allowFullscreen:!0,destroyOnHidden:!0,okButtonProps:{loading:h},okText:s("benchmark.edit.confirm"),open:a,title:s("benchmark.edit.title"),width:480,onCancel:S=>{l.resetFields(),b(!1),t?.(S)},onOk:async S=>{try{const d=await l.validateFields();f(!0),await v({id:m.id,identifier:d.identifier.trim(),name:d.name.trim(),description:d.description?.trim()||void 0,tags:d.tags?.length>0?d.tags:void 0}),g.success(s("benchmark.edit.success")),l.resetFields(),b(!1),t?.(S),D?.()}catch(d){if(d?.errorFields)return;g.error(s("benchmark.edit.error"))}finally{f(!1)}},children:e.jsxs(w,{form:l,layout:"vertical",style:{paddingBlock:16},children:[e.jsx(w.Item,{label:s("benchmark.create.name.label"),name:"name",rules:[{message:s("benchmark.create.nameRequired"),required:!0}],children:e.jsx(ae,{autoFocus:!0,placeholder:s("benchmark.create.name.placeholder")})}),e.jsx(w.Item,{label:s("benchmark.create.identifier.label"),name:"identifier",rules:[{message:s("benchmark.create.identifierRequired"),required:!0}],children:e.jsx(ae,{placeholder:s("benchmark.create.identifier.placeholder"),onChange:()=>b(!0)})}),e.jsx(w.Item,{label:s("benchmark.create.description.label"),name:"description",children:e.jsx(Ie,{placeholder:s("benchmark.create.description.placeholder"),rows:3})}),e.jsx(w.Item,{label:s("benchmark.create.tags.label"),name:"tags",style:{marginBottom:0},children:e.jsx(Fe,{mode:"tags",open:!1,placeholder:s("benchmark.create.tags.placeholder"),style:{width:"100%"},tokenSeparators:[",","，"," "]})})]})})}),se=[o.colorPrimary,o.colorSuccess,o.colorTextQuaternary],R=O(({css:a,cssVar:t})=>({bestPerformance:a`
    margin: 0;
