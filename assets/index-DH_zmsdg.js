import{j as e}from"../vendor/vendor-motion--v3N1cMI.js";import{g as $,ax as q,c as Se,F as r,k as o,I as ne,B as E,f as O,aD as J,a2 as K,C as ke,T as ze,L as Te,aH as F,am as we}from"./index-DgmZNIaB.js";import{r as n}from"../vendor/vendor-emotion-D8kPrniB.js";import{u as I,a as V}from"./store-BAV6_FNw.js";import"../vendor/vendor-es-toolkit-b6vDTgOQ.js";import{e as De}from"./format-Cbjilq94.js";import"./providerConfig-CULHvVzb.js";import{I as ae}from"./Input-BmIFe2jN.js";import{T as Ie}from"./TextArea-CXVosair.js";import{M as oe}from"./Modal-B3X20jog.js";import{S as Fe}from"./Select-Cm6-tKog.js";import{F as w}from"./index-BFj-M3Tp.js";import{f as Be,a as Re}from"./utils-DdCRt2d3.js";import{bc as le,U as Ne,z as Z,co as Ae,cq as Me,bG as ie,c as Pe,a9 as Ee,cr as We,bf as X,aU as H,cs as Le,s as $e,ce as Oe,P as qe,Q as _e,bA as Qe,bD as Ue,bE as He,ak as Ge,bF as Ke,a8 as Ye,bH as Je,bI as Ve,bJ as Ze,bK as Xe}from"../vendor/vendor-icons-DA3bMca7.js";import{D as ce}from"./index-BpHiPB0C.js";import{B as de}from"./index-Bn84oBgm.js";import{g as et,d as U,T as tt,D as at,a as st,b as rt,c as ue,E as nt,R as ot}from"./RunCard-C67twXA0.js";import{I as _}from"./index-BgU0IxlJ.js";import{N as lt}from"./index-H4Kcxd-d.js";import{C as G}from"./index-BqiHXim5.js";import{E as it}from"./Empty-GrClWxIz.js";import{R as ct}from"./index-Ddrvqw6T.js";import{r as pe}from"./selectors-D8FoU16Z.js";import"../i18n/i18n-zh-CN-aruUKrGA.js";import"../i18n/i18n-en-US-DEYXbGUp.js";import"./currency-iJxIWo9y.js";import"./style-OH5WesCm.js";import"./Drawer-redVORT3.js";import"./useForm-BnQPWPAd.js";import"./row-QxnN2HAb.js";import"./index-DgNzT6Qa.js";import"./dropdown-bRrlOkkD.js";import"./LeftOutlined-DNvVoWTJ.js";import"./Dropdown-C1ZSQCvl.js";import"./index-BR4jPa28.js";import"./EllipsisOutlined-BCI2c1Lv.js";import"./index-DOWgPz6W.js";import"./Input-5ZuvCSLw.js";import"./index-DAbF17Is.js";import"./upload-CSS5WmEh.js";import"./index-Crk-7RRS.js";import"./object-4I4CqElr.js";import"./_url-DaEEDvyc.js";import"./v4-BKrj-4V8.js";import"./index-bquewAe9.js";import"./useBubbleLock-BrRBKumo.js";import"./Table-Bfr4stHn.js";import"./index-BQhLeoST.js";import"./scrollTo-DCIbDNqS.js";import"./Pagination-DQ1euRo8.js";import"./index-la9lrC3A.js";import"./CaretDownFilled-CpRtv9h8.js";import"./index-CANaa6Rt.js";import"./index-DhV0QlGt.js";import"./DeleteOutlined-DFutYCzo.js";import"./EyeOutlined-DxITo3I4.js";import"./progress-Dr_MLeSv.js";import"./AccordionItem-BDh7Kae9.js";import"./Block-DajizTW3.js";import"./index-C03wQVBa.js";import"./index-DkFth1RV.js";import"./index-Bmfsw1qi.js";import"./index-B161PuE-.js";import"./PlusOutlined-C6gfUkSw.js";import"./StatusBadge-BOZQyXWL.js";import"./index-COkmQahc.js";const dt=a=>a.trim().toLowerCase().replaceAll(/\s+/g,"-").replaceAll(/[^\da-z-]/g,""),ut=n.memo(({open:a,onCancel:t,benchmark:m,onSuccess:D})=>{const{t:s}=$("eval"),{message:g}=q.useApp(),[l]=w.useForm(),[h,f]=n.useState(!1),[T,b]=n.useState(!1),v=I(S=>S.updateBenchmark),C=w.useWatch("name",l);return n.useEffect(()=>{a&&m&&(l.setFieldsValue({name:m.name,identifier:m.identifier,description:m.description||"",tags:m.tags||[]}),b(!1))},[a,m,l]),n.useEffect(()=>{!T&&C&&l.setFieldValue("identifier",dt(C))},[C,T,l]),e.jsx(oe,{allowFullscreen:!0,destroyOnHidden:!0,okButtonProps:{loading:h},okText:s("benchmark.edit.confirm"),open:a,title:s("benchmark.edit.title"),width:480,onCancel:S=>{l.resetFields(),b(!1),t?.(S)},onOk:async S=>{try{const d=await l.validateFields();f(!0),await v({id:m.id,identifier:d.identifier.trim(),name:d.name.trim(),description:d.description?.trim()||void 0,tags:d.tags?.length>0?d.tags:void 0}),g.success(s("benchmark.edit.success")),l.resetFields(),b(!1),t?.(S),D?.()}catch(d){if(d?.errorFields)return;g.error(s("benchmark.edit.error"))}finally{f(!1)}},children:e.jsxs(w,{form:l,layout:"vertical",style:{paddingBlock:16},children:[e.jsx(w.Item,{label:s("benchmark.create.name.label"),name:"name",rules:[{message:s("benchmark.create.nameRequired"),required:!0}],children:e.jsx(ae,{autoFocus:!0,placeholder:s("benchmark.create.name.placeholder")})}),e.jsx(w.Item,{label:s("benchmark.create.identifier.label"),name:"identifier",rules:[{message:s("benchmark.create.identifierRequired"),required:!0}],children:e.jsx(ae,{placeholder:s("benchmark.create.identifier.placeholder"),onChange:()=>b(!0)})}),e.jsx(w.Item,{label:s("benchmark.create.description.label"),name:"description",children:e.jsx(Ie,{placeholder:s("benchmark.create.description.placeholder"),rows:3})}),e.jsx(w.Item,{label:s("benchmark.create.tags.label"),name:"tags",style:{marginBottom:0},children:e.jsx(Fe,{mode:"tags",open:!1,placeholder:s("benchmark.create.tags.placeholder"),style:{width:"100%"},tokenSeparators:[",","，"," "]})})]})})}),se=[o.colorPrimary,o.colorSuccess,o.colorTextQuaternary],R=O(({css:a,cssVar:t})=>({bestPerformance:a`
    margin: 0;
  ...
  `})),jt=n.memo(({benchmarkId:a,dataset:t,isExpanded:m,loading:D,total:s,filteredCases:g,search:l,diffFilter:h,pagination:f,onExpand:T,onEdit:b,onDeleteCase:v,onRefresh:C,onSearchChange:S,onDiffFilterChange:d,onPageChange:c,onAddCase:W,onImport:N,onRun:j})=>{const{t:k}=$("eval"),{modal:p,message:y}=q.useApp(),A=n.useCallback(()=>{p.confirm({content:k("dataset.delete.confirm"),okButtonProps:{danger:!0},okText:k("common.delete"),onOk:async()=>{try{await V.deleteDataset(t.id),y.success(k("dataset.delete.success")),C()}catch{y.error(k("dataset.delete.error"))}},title:k("common.delete")})},[t.id,y,p,C,k]);return e.jsxs(G,{className:P.card,children:[e.jsxs("div",{className:P.datasetHeader,onClick:T,children:[e.jsx("div",{className:P.datasetIcon,children:e.jsx(X,{size:16,style:{color:"var(--ant-color-primary)"}})}),e.jsxs(r,{flex:1,gap:2,style:{minWidth:0},children:[e.jsxs(r,{horizontal:!0,align:"center",gap:8,children:[e.jsx("p",{className:P.datasetName,children:t.name}),t.metadata?.preset&&U[t.metadata.preset]&&e.jsx(ze,{style:{fontSize:10},children:U[t.metadata.preset].name})]}),t.description&&e.jsx("p",{className:P.datasetDescription,children:t.description})]}),e.jsxs("span",{className:P.caseCount,children:[t.testCaseCount||0," ",k("benchmark.detail.stats.cases").toLowerCase()]}),e.jsx(E,{icon:$e,size:"small",style:{height:28},onClick:L=>{L.stopPropagation(),j()},children:k("run.actions.run")}),e.jsx(ce,{trigger:["click"],menu:{items:[{icon:e.jsx(qe,{size:14}),key:"edit",label:k("common.edit"),onClick:()=>b(t)},{type:"divider"},{danger:!0,icon:e.jsx(le,{size:14}),key:"delete",label:k("common.delete"),onClick:A}]},children:e.jsx(E,{className:P.dropdownButton,icon:Oe,size:"small",variant:"text",onClick:L=>L.stopPropagation()})}),e.jsx(_e,{size:16,style:{color:"var(--ant-color-text-tertiary)",transform:m?"rotate(90deg)":"rotate(0deg)",transition:"transform 0.2s"}})]}),m&&e.jsxs("div",{className:P.expandedSection,children:[D?e.jsx(r,{align:"center",justify:"center",style:{padding:"48px 24px"},children:e.jsx(lt,{size:48})}):s===0?e.jsx(ft,{onAddCase:W,onImport:N}):e.jsx(tt,{readOnly:!0,datasetEvalMode:t.evalMode,diffFilter:h,pagination:f,search:l,testCases:g,total:s,onDiffFilterChange:d,onPageChange:c,onSearchChange:S}),e.jsx(r,{horizontal:!0,align:"center",className:P.footer,justify:"center",children:e.jsx(Te,{className:P.footerLink,to:`/eval/bench/${a}/datasets/${t.id}`,children:e.jsx(E,{icon:Qe,iconPosition:"end",size:"small",variant:"text",children:k("dataset.detail.viewDetail")})})})]})]})}),yt=O(({css:a,cssVar:t})=>({emptyCard:a`
    .ant-card-body {
      display: flex;
