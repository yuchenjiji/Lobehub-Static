import{j as e}from"../vendor/vendor-motion-D2gXNOxm.js";import{j as $,az as _,e as Se,F as r,m as o,I as ne,B as E,h as O,aF as Y,y as J,C as ze,T as ke,L as Te,aJ as F,ap as we}from"./index-Cbsc4Bbc.js";import{r as n}from"../vendor/vendor-emotion-D8kPrniB.js";import{u as I,a as Z}from"./store-CiTVZGea.js";import"../vendor/vendor-es-toolkit-BI0f0n_g.js";import{e as De}from"./format-B_ObzesU.js";import"./providerConfig-CULHvVzb.js";import{I as ae}from"./Input-CVfU_1Jt.js";import{T as Ie}from"./TextArea-NE9IH04E.js";import{M as oe}from"./Modal-BUUJgFpO.js";import{S as Fe}from"./Select-Di_SKg6I.js";import{F as w}from"./index-DsTXqjor.js";import{f as Be,a as Re}from"./utils-DdCRt2d3.js";import{bc as le,U as Ne,z as V,cv as Ae,cx as Me,bG as ie,c as Pe,a9 as Ee,cy as We,bf as X,aZ as H,cz as Le,s as $e,cl as Oe,P as _e,Q as qe,bA as Qe,bD as Ue,bE as He,ak as Ge,bF as Je,a8 as Ke,bH as Ye,bI as Ze,bJ as Ve,bK as Xe}from"../vendor/vendor-icons-UxbXHH06.js";import{D as ce}from"./index--3CgWjkj.js";import{B as de}from"./index-DzgkZQ5H.js";import{g as et,d as U,T as tt,D as at,a as st,b as rt,c as ue,E as nt,R as ot}from"./RunCard-BPNLIhd7.js";import{I as q}from"./index-CkYIz5-n.js";import{N as lt}from"./index-CGEsfiwY.js";import{C as G}from"./index-D7lW3FX6.js";import{E as it}from"./Empty-DVRTHTrA.js";import{R as ct}from"./index-UZxlXqm3.js";import{r as pe}from"./selectors-D8FoU16Z.js";import"../i18n/i18n-zh-CN-X4QEO1fZ.js";import"../i18n/i18n-en-US-CeDxYD3m.js";import"./currency-iJxIWo9y.js";import"./style-DIjtNsyo.js";import"./Drawer-KzeGqrMB.js";import"./useForm-CT5Qe__1.js";import"./row-D2ecpczz.js";import"./index-BUIXHVtG.js";import"./LeftOutlined-D3LJSxae.js";import"./Dropdown-Dpyk3MJB.js";import"./index-BYA6zDr_.js";import"./EllipsisOutlined-XdRn1CM7.js";import"./index-B-TfYDu1.js";import"./Addon-DISrJSNy.js";import"./upload-BxTVLs1v.js";import"./index-B4bY_61f.js";import"./object-Cz6o-AEA.js";import"./_url-BMVuWu_J.js";import"./v4-BKrj-4V8.js";import"./index-B0DT-BOK.js";import"./useBubbleLock-6kkEthu_.js";import"./Table-oegGHkx-.js";import"./index-cRbfdIde.js";import"./scrollTo-BRMvk2RN.js";import"./Pagination-D7ifNDpc.js";import"./index-BoKdL3KT.js";import"./index-D49eVKhS.js";import"./Input-BLyXeXNO.js";import"./index-Dgj-BlpT.js";import"./index-XZU4-tVW.js";import"./DeleteOutlined-DFutYCzo.js";import"./EyeOutlined-DYIcZyRL.js";import"./progress-B54RW4Se.js";import"./AccordionItem-Bu_3IQYZ.js";import"./Block-B7Wwf0Pg.js";import"./index-Dqkj3OU3.js";import"./index-DcIHB0uR.js";import"./index-sc-I71Eb.js";import"./index-B8PdUk4X.js";import"./PlusOutlined-BsduHN_Q.js";import"./StatusBadge-D3ruCq0s.js";import"./TextArea-DBdEYVUq.js";import"./index-BAC3Yir3.js";const dt=a=>a.trim().toLowerCase().replaceAll(/\s+/g,"-").replaceAll(/[^\da-z-]/g,""),ut=n.memo(({open:a,onCancel:t,benchmark:m,onSuccess:D})=>{const{t:s}=$("eval"),{message:g}=_.useApp(),[l]=w.useForm(),[h,f]=n.useState(!1),[T,b]=n.useState(!1),v=I(S=>S.updateBenchmark),C=w.useWatch("name",l);return n.useEffect(()=>{a&&m&&(l.setFieldsValue({name:m.name,identifier:m.identifier,description:m.description||"",tags:m.tags||[]}),b(!1))},[a,m,l]),n.useEffect(()=>{!T&&C&&l.setFieldValue("identifier",dt(C))},[C,T,l]),e.jsx(oe,{allowFullscreen:!0,destroyOnHidden:!0,okButtonProps:{loading:h},okText:s("benchmark.edit.confirm"),open:a,title:s("benchmark.edit.title"),width:480,onCancel:S=>{l.resetFields(),b(!1),t?.(S)},onOk:async S=>{try{const d=await l.validateFields();f(!0),await v({id:m.id,identifier:d.identifier.trim(),name:d.name.trim(),description:d.description?.trim()||void 0,tags:d.tags?.length>0?d.tags:void 0}),g.success(s("benchmark.edit.success")),l.resetFields(),b(!1),t?.(S),D?.()}catch(d){if(d?.errorFields)return;g.error(s("benchmark.edit.error"))}finally{f(!1)}},children:e.jsxs(w,{form:l,layout:"vertical",style:{paddingBlock:16},children:[e.jsx(w.Item,{label:s("benchmark.create.name.label"),name:"name",rules:[{message:s("benchmark.create.nameRequired"),required:!0}],children:e.jsx(ae,{autoFocus:!0,placeholder:s("benchmark.create.name.placeholder")})}),e.jsx(w.Item,{label:s("benchmark.create.identifier.label"),name:"identifier",rules:[{message:s("benchmark.create.identifierRequired"),required:!0}],children:e.jsx(ae,{placeholder:s("benchmark.create.identifier.placeholder"),onChange:()=>b(!0)})}),e.jsx(w.Item,{label:s("benchmark.create.description.label"),name:"description",children:e.jsx(Ie,{placeholder:s("benchmark.create.description.placeholder"),rows:3})}),e.jsx(w.Item,{label:s("benchmark.create.tags.label"),name:"tags",style:{marginBottom:0},children:e.jsx(Fe,{mode:"tags",open:!1,placeholder:s("benchmark.create.tags.placeholder"),style:{width:"100%"},tokenSeparators:[",","，"," "]})})]})})}),se=[o.colorPrimary,o.colorSuccess,o.colorTextQuaternary],R=O(({css:a,cssVar:t})=>({bestPerformance:a`
    margin: 0;
