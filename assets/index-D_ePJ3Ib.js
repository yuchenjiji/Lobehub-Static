import{fh as ae,J as H,b as L,h as T,j as w,l as b,y as A,i as M,dm as se,F as g,A as W,O as Z,P as ie,d as le,aX as ce,Y as de,f2 as ue,a3 as he,B as G,I as pe,m as y,a6 as me,ai as fe,g as ge,fi as xe,fj as ve,fk as ye,as as be,bj as we,bq as Se}from"./index-BlXf1DT_.js";import{r as i}from"../vendor/vendor-emotion-D8kPrniB.js";import{f as ke,J as Te,j as B,k as Ie,D as Ae,K as D,u as J}from"./index-BS0oxcSC.js";import{s as F,g as K}from"./index-Bf39sI8h.js";import{j as n}from"../vendor/vendor-motion-D2gXNOxm.js";import{P as Me}from"./PopoverGroup-sMmtc4zs.js";import{B as je}from"./Block-CaxDTBwJ.js";import{k as Ce}from"./Popover-B0kX1Bii.js";import{u as P,i as _}from"./index-BIQrmAwO.js";import{m as Pe}from"./markdownToTxt-DCG-YiEI.js";import{c as N}from"./useOperationState-DjQfUThz.js";import{df as _e,b2 as Ne,aZ as q,bd as Ee}from"../vendor/vendor-icons-UxbXHH06.js";import"./providerConfig-CULHvVzb.js";import{A as ze}from"./Alert-BfF59oJG.js";import{A as Q}from"./index-QeoY0oy6.js";import{u as Y}from"./MarketAuthProvider-DB5VqPek.js";import{D as $e}from"./index-C74cxLxW.js";import{u as We,p as Be}from"./useQueryParam-BZnR0abI.js";import{D as De}from"./index-BRy-gNZV.js";import{p as V,P as ee}from"./router-DDp2NG8u.js";import{M as He}from"./Modal-BRe8tRgU.js";const Le=i.memo(()=>{const{analytics:e}=ae(),t=i.useCallback(()=>{const l=F.currentSession(K()),o=l?.id,c=F.defaultSessions(K()),r=H.showRightPanel(L.getState()),h=ke.activeDisplayMessages(Te());return{active_assistant:o==="inbox"?null:l?.meta?.title||null,has_chat_history:h.length>0,session_id:o||"inbox",sidebar_state:r?"expanded":"collapsed",visible_assistants_count:c.length}},[]);return i.useEffect(()=>{if(!e)return;const l=setTimeout(()=>{e.track({name:"main_page_view",properties:{...t(),spm:"main_page.interface.view"}})},1e3);return()=>clearTimeout(l)},[e,t]),null});Le.displayName="MainInterfaceTracker";const Re=T(({css:e,cssVar:t})=>({arrow:e`
    opacity: 0;
