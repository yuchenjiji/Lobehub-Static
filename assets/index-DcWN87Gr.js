import{j as t}from"../vendor/vendor-motion-D2gXNOxm.js";import{a4 as $,F as g,y as M,h as S,j as C,bo as T,aA as L,B as w}from"./index-C3MhWRwW.js";import{M as B}from"./Modal-BollL6a2.js";import{r as i}from"../vendor/vendor-emotion-D8kPrniB.js";import{S as _}from"./SearchBar-D0YNwAm0.js";import{S as j}from"./index-BYieySQS.js";import{q as N}from"./index-DDr7f63T.js";import{A as k}from"./AgentSelectionEmpty-CVCmefg3.js";import{A as R}from"./index-Csk4ZgJo.js";import{C as F}from"./index-DkuGXEhz.js";import{a as z}from"./index-WgbNZGtF.js";import{c as E}from"./react-BI9R7P-B.js";import{bd as q}from"../vendor/vendor-icons-UxbXHH06.js";import{D}from"./index-Cnh4-bhC.js";const x=E((e,o)=>({clearSelection:()=>{e({selectedAgentIds:[]})},isSelected:n=>o().selectedAgentIds.includes(n),removeAgent:n=>{e(r=>({selectedAgentIds:r.selectedAgentIds.filter(l=>l!==n)}))},selectedAgentIds:[],setSelectedAgents:n=>{e({selectedAgentIds:n})},toggleAgent:n=>{e(r=>r.selectedAgentIds.includes(n)?{selectedAgentIds:r.selectedAgentIds.filter(s=>s!==n)}:{selectedAgentIds:[...r.selectedAgentIds,n]})}})),y=S(({css:e,cssVar:o})=>({item:e`
    cursor: pointer;
