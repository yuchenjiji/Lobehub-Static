import{j as t}from"../vendor/vendor-motion-D2gXNOxm.js";import{a4 as $,F as g,y as M,h as S,j as C,bo as T,aA as L,B as w}from"./index-VN8sB35D.js";import{M as B}from"./Modal-DrVW__FB.js";import{r as i}from"../vendor/vendor-emotion-D8kPrniB.js";import{S as _}from"./SearchBar-7FtGdfxJ.js";import{S as j}from"./index-CHyRCWIy.js";import{q as N}from"./index-CWzkDngG.js";import{A as k}from"./AgentSelectionEmpty-UY7WBEqq.js";import{A as R}from"./index-BXdkY-wn.js";import{C as F}from"./index-s5d_fXyU.js";import{a as z}from"./index-PPNy93Jg.js";import{c as E}from"./react-id-zsU4l.js";import{bd as q}from"../vendor/vendor-icons-UxbXHH06.js";import{D}from"./index-DVTH5a0j.js";const x=E((e,o)=>({clearSelection:()=>{e({selectedAgentIds:[]})},isSelected:n=>o().selectedAgentIds.includes(n),removeAgent:n=>{e(r=>({selectedAgentIds:r.selectedAgentIds.filter(l=>l!==n)}))},selectedAgentIds:[],setSelectedAgents:n=>{e({selectedAgentIds:n})},toggleAgent:n=>{e(r=>r.selectedAgentIds.includes(n)?{selectedAgentIds:r.selectedAgentIds.filter(s=>s!==n)}:{selectedAgentIds:[...r.selectedAgentIds,n]})}})),y=S(({css:e,cssVar:o})=>({item:e`
    cursor: pointer;
