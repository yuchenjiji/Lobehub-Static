import{j as e}from"../vendor/vendor-motion-D2gXNOxm.js";import{j as $,az as _,e as Se,F as r,m as o,I as ne,B as E,h as O,aF as Y,y as J,C as ze,T as ke,L as Te,aJ as F,ap as we}from"./index-ByRn-atB.js";import{r as n}from"../vendor/vendor-emotion-D8kPrniB.js";import{u as I,a as Z}from"./store-tneefrOH.js";import"../vendor/vendor-es-toolkit-BI0f0n_g.js";import{e as De}from"./format-4UuvJk6N.js";import"./providerConfig-CULHvVzb.js";import{I as ae}from"./Input-DMLlHdAx.js";import{T as Ie}from"./TextArea-BBw1ZSxV.js";import{M as oe}from"./Modal-xx0gJI_s.js";import{S as Fe}from"./Select-DOJkZdw_.js";import{F as w}from"./index-DH1Yxnn_.js";import{f as Be,a as Re}from"./utils-DdCRt2d3.js";import{bc as le,U as Ne,z as V,cv as Ae,cx as Me,bG as ie,c as Pe,a9 as Ee,cy as We,bf as X,aZ as H,cz as Le,s as $e,cl as Oe,P as _e,Q as qe,bA as Qe,bD as Ue,bE as He,ak as Ge,bF as Je,a8 as Ke,bH as Ye,bI as Ze,bJ as Ve,bK as Xe}from"../vendor/vendor-icons-UxbXHH06.js";import{D as ce}from"./index-ChLURl1o.js";import{B as de}from"./index-DRy1xnz3.js";import{g as et,d as U,T as tt,D as at,a as st,b as rt,c as ue,E as nt,R as ot}from"./RunCard-BTiO9w3M.js";import{I as q}from"./index-CWdw2z44.js";import{N as lt}from"./index-Bdb0iQfg.js";import{C as G}from"./index-DkRsYXun.js";import{E as it}from"./Empty-B4tG5rZk.js";import{R as ct}from"./index-BB4yEy5E.js";import{r as pe}from"./selectors-D8FoU16Z.js";import"../i18n/i18n-zh-CN-X4QEO1fZ.js";import"../i18n/i18n-en-US-CeDxYD3m.js";import"./currency-iJxIWo9y.js";import"./style-DErE9qhu.js";import"./Drawer-Dj61BhTU.js";import"./useForm-CSvn6h2q.js";import"./row-cVIlBBzp.js";import"./index-DWZgkrRC.js";import"./LeftOutlined-CzG6Vblo.js";import"./Dropdown-4EGwBugk.js";import"./index-DYuQkL2F.js";import"./EllipsisOutlined-BLT3xrqp.js";import"./index-CdfgVSXN.js";import"./Addon-DB1D3fvC.js";import"./upload-B100xAno.js";import"./index-BBVZK1z_.js";import"./object-Cz6o-AEA.js";import"./_url-NcJTnnlj.js";import"./v4-BKrj-4V8.js";import"./index-DYvQqU2K.js";import"./useBubbleLock-6kkEthu_.js";import"./Table-BpsSNeEJ.js";import"./index-wiO2oo9C.js";import"./scrollTo-BJF3udcO.js";import"./Pagination-uTkdFZe2.js";import"./index-Dq1cZtVX.js";import"./index-JIVEeSyM.js";import"./Input-B-gxgfv1.js";import"./index-PMHOEYBb.js";import"./index-DyVPFlYT.js";import"./DeleteOutlined-DFutYCzo.js";import"./EyeOutlined-DyS03Kuw.js";import"./progress-DVlGmL9o.js";import"./AccordionItem--3lOgcp8.js";import"./Block-BeaZPAE6.js";import"./index-DowEgs2W.js";import"./index-DgV7oIww.js";import"./index-Cd6V5Ypb.js";import"./index-BD-i-5Vh.js";import"./PlusOutlined-DFBXzjcl.js";import"./StatusBadge-BdAH4dY_.js";import"./TextArea-9CeCxltO.js";import"./index-CLSthr3e.js";const dt=a=>a.trim().toLowerCase().replaceAll(/\s+/g,"-").replaceAll(/[^\da-z-]/g,""),ut=n.memo(({open:a,onCancel:t,benchmark:m,onSuccess:D})=>{const{t:s}=$("eval"),{message:g}=_.useApp(),[l]=w.useForm(),[h,f]=n.useState(!1),[T,b]=n.useState(!1),v=I(S=>S.updateBenchmark),C=w.useWatch("name",l);return n.useEffect(()=>{a&&m&&(l.setFieldsValue({name:m.name,identifier:m.identifier,description:m.description||"",tags:m.tags||[]}),b(!1))},[a,m,l]),n.useEffect(()=>{!T&&C&&l.setFieldValue("identifier",dt(C))},[C,T,l]),e.jsx(oe,{allowFullscreen:!0,destroyOnHidden:!0,okButtonProps:{loading:h},okText:s("benchmark.edit.confirm"),open:a,title:s("benchmark.edit.title"),width:480,onCancel:S=>{l.resetFields(),b(!1),t?.(S)},onOk:async S=>{try{const d=await l.validateFields();f(!0),await v({id:m.id,identifier:d.identifier.trim(),name:d.name.trim(),description:d.description?.trim()||void 0,tags:d.tags?.length>0?d.tags:void 0}),g.success(s("benchmark.edit.success")),l.resetFields(),b(!1),t?.(S),D?.()}catch(d){if(d?.errorFields)return;g.error(s("benchmark.edit.error"))}finally{f(!1)}},children:e.jsxs(w,{form:l,layout:"vertical",style:{paddingBlock:16},children:[e.jsx(w.Item,{label:s("benchmark.create.name.label"),name:"name",rules:[{message:s("benchmark.create.nameRequired"),required:!0}],children:e.jsx(ae,{autoFocus:!0,placeholder:s("benchmark.create.name.placeholder")})}),e.jsx(w.Item,{label:s("benchmark.create.identifier.label"),name:"identifier",rules:[{message:s("benchmark.create.identifierRequired"),required:!0}],children:e.jsx(ae,{placeholder:s("benchmark.create.identifier.placeholder"),onChange:()=>b(!0)})}),e.jsx(w.Item,{label:s("benchmark.create.description.label"),name:"description",children:e.jsx(Ie,{placeholder:s("benchmark.create.description.placeholder"),rows:3})}),e.jsx(w.Item,{label:s("benchmark.create.tags.label"),name:"tags",style:{marginBottom:0},children:e.jsx(Fe,{mode:"tags",open:!1,placeholder:s("benchmark.create.tags.placeholder"),style:{width:"100%"},tokenSeparators:[",","，"," "]})})]})})}),se=[o.colorPrimary,o.colorSuccess,o.colorTextQuaternary],R=O(({css:a,cssVar:t})=>({bestPerformance:a`
    margin: 0;
