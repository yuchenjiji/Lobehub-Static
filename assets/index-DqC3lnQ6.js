import{j as t}from"../vendor/vendor-motion-D2gXNOxm.js";import{a4 as $,F as g,y as M,h as S,j as C,bo as T,aA as L,B as w}from"./index-DuTkvx3R.js";import{M as B}from"./Modal-B9x1oMV2.js";import{r as i}from"../vendor/vendor-emotion-D8kPrniB.js";import{S as _}from"./SearchBar-D1raqoLp.js";import{S as j}from"./index-rVIaLnR4.js";import{q as N}from"./index-Cu7yQ_d-.js";import{A as k}from"./AgentSelectionEmpty-C9ZjFPcG.js";import{A as R}from"./index-3_OIRYp9.js";import{C as F}from"./index-C4tkYPlx.js";import{a as z}from"./index-BSLNWx7P.js";import{c as E}from"./react--88G1uy9.js";import{bd as q}from"../vendor/vendor-icons-UxbXHH06.js";import{D}from"./index-BuVnyVPZ.js";const x=E((e,o)=>({clearSelection:()=>{e({selectedAgentIds:[]})},isSelected:n=>o().selectedAgentIds.includes(n),removeAgent:n=>{e(r=>({selectedAgentIds:r.selectedAgentIds.filter(l=>l!==n)}))},selectedAgentIds:[],setSelectedAgents:n=>{e({selectedAgentIds:n})},toggleAgent:n=>{e(r=>r.selectedAgentIds.includes(n)?{selectedAgentIds:r.selectedAgentIds.filter(s=>s!==n)}:{selectedAgentIds:[...r.selectedAgentIds,n]})}})),y=S(({css:e,cssVar:o})=>({item:e`
    cursor: pointer;
