import{j as t}from"../vendor/vendor-motion-D2gXNOxm.js";import{a4 as $,F as g,y as M,h as S,j as C,bo as T,aA as L,B as w}from"./index-DpjtaJho.js";import{M as B}from"./Modal-CkXXIJVM.js";import{r as i}from"../vendor/vendor-emotion-D8kPrniB.js";import{S as _}from"./SearchBar-C3mggMeU.js";import{S as j}from"./index-Chn5HXuX.js";import{q as N}from"./index-DHpRjeph.js";import{A as k}from"./AgentSelectionEmpty-DgTf_LZN.js";import{A as R}from"./index-BzTAHP7_.js";import{C as F}from"./index-BTa0yapQ.js";import{a as z}from"./index-Cg1w8av1.js";import{c as E}from"./react-Bl0MyDgK.js";import{bd as q}from"../vendor/vendor-icons-UxbXHH06.js";import{D}from"./index-CDOSUgZb.js";const x=E((e,o)=>({clearSelection:()=>{e({selectedAgentIds:[]})},isSelected:n=>o().selectedAgentIds.includes(n),removeAgent:n=>{e(r=>({selectedAgentIds:r.selectedAgentIds.filter(l=>l!==n)}))},selectedAgentIds:[],setSelectedAgents:n=>{e({selectedAgentIds:n})},toggleAgent:n=>{e(r=>r.selectedAgentIds.includes(n)?{selectedAgentIds:r.selectedAgentIds.filter(s=>s!==n)}:{selectedAgentIds:[...r.selectedAgentIds,n]})}})),y=S(({css:e,cssVar:o})=>({item:e`
    cursor: pointer;
