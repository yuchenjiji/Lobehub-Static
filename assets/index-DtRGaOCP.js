import{j as t}from"../vendor/vendor-motion-ksfQGfvU.js";import{a4 as $,F as g,y as M,h as S,j as C,bo as T,aA as L,B as w}from"./index-BTYm_psc.js";import{M as B}from"./Modal-DBI8gkBV.js";import{r as i}from"../vendor/vendor-emotion-D8kPrniB.js";import{S as _}from"./SearchBar-C5L-GYDn.js";import{S as j}from"./index-Brfh3dbY.js";import{q as N}from"./index-nNJ9tBys.js";import{A as k}from"./AgentSelectionEmpty-nU7nVTFk.js";import{A as R}from"./index-C8i9ldt0.js";import{C as F}from"./index-20hx6Iz7.js";import{a as z}from"./index-DOC2z7n8.js";import{c as E}from"./react-DyU13ndT.js";import{bd as q}from"../vendor/vendor-icons-UxbXHH06.js";import{D}from"./index-DdShcdJZ.js";const x=E((e,o)=>({clearSelection:()=>{e({selectedAgentIds:[]})},isSelected:n=>o().selectedAgentIds.includes(n),removeAgent:n=>{e(r=>({selectedAgentIds:r.selectedAgentIds.filter(l=>l!==n)}))},selectedAgentIds:[],setSelectedAgents:n=>{e({selectedAgentIds:n})},toggleAgent:n=>{e(r=>r.selectedAgentIds.includes(n)?{selectedAgentIds:r.selectedAgentIds.filter(s=>s!==n)}:{selectedAgentIds:[...r.selectedAgentIds,n]})}})),y=S(({css:e,cssVar:o})=>({item:e`
    cursor: pointer;
