import{j as t}from"../vendor/vendor-motion-D2gXNOxm.js";import{a4 as $,F as g,y as M,h as S,j as C,bo as T,aA as L,B as w}from"./index-Dw0E06JZ.js";import{M as B}from"./Modal-4AdmG9de.js";import{r as i}from"../vendor/vendor-emotion-D8kPrniB.js";import{S as _}from"./SearchBar-olbw5xJV.js";import{S as j}from"./index-DxOkZSvZ.js";import{q as N}from"./index-DBS70GJW.js";import{A as k}from"./AgentSelectionEmpty-B93xam0o.js";import{A as R}from"./index-Bgs8TlXg.js";import{C as F}from"./index-CCbQx8Wm.js";import{a as z}from"./index-CnpyjJpp.js";import{c as E}from"./react-Dye3_POh.js";import{bd as q}from"../vendor/vendor-icons-UxbXHH06.js";import{D}from"./index-DfbBBsev.js";const x=E((e,o)=>({clearSelection:()=>{e({selectedAgentIds:[]})},isSelected:n=>o().selectedAgentIds.includes(n),removeAgent:n=>{e(r=>({selectedAgentIds:r.selectedAgentIds.filter(l=>l!==n)}))},selectedAgentIds:[],setSelectedAgents:n=>{e({selectedAgentIds:n})},toggleAgent:n=>{e(r=>r.selectedAgentIds.includes(n)?{selectedAgentIds:r.selectedAgentIds.filter(s=>s!==n)}:{selectedAgentIds:[...r.selectedAgentIds,n]})}})),y=S(({css:e,cssVar:o})=>({item:e`
    cursor: pointer;
