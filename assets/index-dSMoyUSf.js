import{j as t}from"../vendor/vendor-motion-D2gXNOxm.js";import{a4 as $,F as g,y as M,h as S,j as C,bo as T,aA as L,B as w}from"./index-BlXf1DT_.js";import{M as B}from"./Modal-BRe8tRgU.js";import{r as i}from"../vendor/vendor-emotion-D8kPrniB.js";import{S as _}from"./SearchBar-DjDK8cBW.js";import{S as j}from"./index-DmK6jkcV.js";import{q as N}from"./index-fM1yGMYM.js";import{A as k}from"./AgentSelectionEmpty-DpKVDiD-.js";import{A as R}from"./index-QeoY0oy6.js";import{C as F}from"./index-bYeduNjs.js";import{a as z}from"./index-BRy-gNZV.js";import{c as E}from"./react-C-sOXaMy.js";import{bd as q}from"../vendor/vendor-icons-UxbXHH06.js";import{D}from"./index-C74cxLxW.js";const x=E((e,o)=>({clearSelection:()=>{e({selectedAgentIds:[]})},isSelected:n=>o().selectedAgentIds.includes(n),removeAgent:n=>{e(r=>({selectedAgentIds:r.selectedAgentIds.filter(l=>l!==n)}))},selectedAgentIds:[],setSelectedAgents:n=>{e({selectedAgentIds:n})},toggleAgent:n=>{e(r=>r.selectedAgentIds.includes(n)?{selectedAgentIds:r.selectedAgentIds.filter(s=>s!==n)}:{selectedAgentIds:[...r.selectedAgentIds,n]})}})),y=S(({css:e,cssVar:o})=>({item:e`
    cursor: pointer;
