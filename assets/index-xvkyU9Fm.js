import{fh as ae,J as H,b as L,h as T,j as w,l as b,y as A,i as M,dm as se,F as g,A as W,O as Z,P as ie,d as le,aX as ce,Y as de,f2 as ue,a3 as he,B as G,I as pe,m as y,a6 as me,ai as fe,g as ge,fi as xe,fj as ve,fk as ye,as as be,bj as we,bq as Se}from"./index-Co46OOry.js";import{r as i}from"../vendor/vendor-emotion-D8kPrniB.js";import{f as ke,J as Te,j as B,k as Ie,D as Ae,K as D,u as J}from"./index-BZnpdA0C.js";import{s as F,g as K}from"./index-BT19Qhv5.js";import{j as n}from"../vendor/vendor-motion-D2gXNOxm.js";import{P as Me}from"./PopoverGroup-BT-yTzH7.js";import{B as je}from"./Block-DTrzmjZ1.js";import{k as Ce}from"./Popover-BoXT8pgg.js";import{u as P,i as _}from"./index-BLdoNI6i.js";import{m as Pe}from"./markdownToTxt-xoEhPXHA.js";import{c as N}from"./useOperationState-CAn1HE0f.js";import{df as _e,b2 as Ne,aZ as q,bd as Ee}from"../vendor/vendor-icons-UxbXHH06.js";import"./providerConfig-CULHvVzb.js";import{A as ze}from"./Alert-9qBPMMxV.js";import{A as Q}from"./index-CMPDGxbE.js";import{u as Y}from"./MarketAuthProvider-BMp9IGjs.js";import{D as $e}from"./index-STNGqpwv.js";import{u as We,p as Be}from"./useQueryParam-D-2aWm9B.js";import{D as De}from"./index-D_2VIjXW.js";import{p as V,P as ee}from"./router-CflGzJG-.js";import{M as He}from"./Modal-C9AneL8v.js";const Le=i.memo(()=>{const{analytics:e}=ae(),t=i.useCallback(()=>{const l=F.currentSession(K()),o=l?.id,c=F.defaultSessions(K()),r=H.showRightPanel(L.getState()),h=ke.activeDisplayMessages(Te());return{active_assistant:o==="inbox"?null:l?.meta?.title||null,has_chat_history:h.length>0,session_id:o||"inbox",sidebar_state:r?"expanded":"collapsed",visible_assistants_count:c.length}},[]);return i.useEffect(()=>{if(!e)return;const l=setTimeout(()=>{e.track({name:"main_page_view",properties:{...t(),spm:"main_page.interface.view"}})},1e3);return()=>clearTimeout(l)},[e,t]),null});Le.displayName="MainInterfaceTracker";const Re=T(({css:e,cssVar:t})=>({arrow:e`
    opacity: 0;
